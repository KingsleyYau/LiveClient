...
void cs_MD5_Update(MD5_CTX *ctx, const unsigned char *buf, size_t len) {
  uint32_t t;
...
void cs_MD5_Final(unsigned char digest[16], MD5_CTX *ctx) {
  unsigned count;
  unsigned char *p;
  uint32_t *a;
