 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatGetUserInfoTask.h
 *   desc: 获取用户信息Task实现类
 */
...
class LSLiveChatGetUserInfoTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetUserInfoTask(void);
	virtual ~LSLiveChatGetUserInfoTask(void);
