 ...
 * author: Samson.Fan
 *   date: 2016-04-25
 *   file: LSLiveChatPlayThemeMotionTask.h
...
class LSLiveChatPlayThemeMotionTask : public ILSLiveChatTask
{
public:
	LSLiveChatPlayThemeMotionTask(void);
	virtual ~LSLiveChatPlayThemeMotionTask(void);
