 ...
 * author: Samson.Fan
 *   date: 2016-04-25
 *   file: LSLiveChatGetPaidThemeTask.h
...
class LSLiveChatGetPaidThemeTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetPaidThemeTask(void);
	virtual ~LSLiveChatGetPaidThemeTask(void);
