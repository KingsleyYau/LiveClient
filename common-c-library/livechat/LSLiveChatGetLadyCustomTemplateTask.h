 ...
 * author: Samson.Fan
 *   date: 2016-03-24
 *   file: LSLiveChatGetLadyCustomTemplateTask.h
...
class LSLiveChatGetLadyCustomTemplateTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetLadyCustomTemplateTask(void);
	virtual ~LSLiveChatGetLadyCustomTemplateTask(void);
