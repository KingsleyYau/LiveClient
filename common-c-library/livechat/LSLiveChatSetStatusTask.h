...
class LSLiveChatSetStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatSetStatusTask(void);
	virtual ~LSLiveChatSetStatusTask(void);
...
public:
	// 初始化参数
	bool InitParam(USER_STATUS_TYPE status);
