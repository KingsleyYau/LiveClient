 ...
 * author: Samson.Fan
 *   date: 2016-03-24
 *   file: LSLiveChatGetLadyConditionTask.h
...
class LSLiveChatGetLadyConditionTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetLadyConditionTask(void);
	virtual ~LSLiveChatGetLadyConditionTask(void);
