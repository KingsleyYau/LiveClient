 ...
 * author: Samson.Fan
 *   date: 2015-03-31
 *   file: LSLiveChatUploadTicketTask.h
 *   desc: 上传票根Task实现类
 */
...
class LSLiveChatUploadTicketTask : public ILSLiveChatTask
{
public:
	LSLiveChatUploadTicketTask(void);
	virtual ~LSLiveChatUploadTicketTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, int ticket);
