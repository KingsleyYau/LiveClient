 ...
 * author: Alex shum
 *   date: 2016-08-24
 *   file: LSLiveChatSendThemeRecommendTask.h
...
class LSLiveChatSendThemeRecommendTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendThemeRecommendTask(void);
	virtual ~LSLiveChatSendThemeRecommendTask(void);
