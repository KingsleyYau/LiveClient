 ...
 * author: Hunter.Mun
 *   date: 2017-1.4
 *   file: LSLiveChatCamshareUseTryTicketTask.h
...
class LSLiveChatCamshareUseTryTicketTask : public ILSLiveChatTask
{
public:
	LSLiveChatCamshareUseTryTicketTask(void);
	virtual ~LSLiveChatCamshareUseTryTicketTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, const string& ticketId);
