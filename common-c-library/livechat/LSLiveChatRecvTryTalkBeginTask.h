 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvTryTalkBeginTask.h
 *   desc: 接收试聊开始Task实现类
 */
...
class LSLiveChatRecvTryTalkBeginTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvTryTalkBeginTask(void);
	virtual ~LSLiveChatRecvTryTalkBeginTask(void);
...
private:
	...
	string			m_toId;		// 被发起用户Id
	string			m_fromId;	// 发起用户Id
	int				m_time;		// 试聊时长（秒）
};
