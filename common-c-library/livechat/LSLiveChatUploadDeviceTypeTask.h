...
class LSLiveChatUploadDeviceTypeTask : public ILSLiveChatTask
{
public:
	LSLiveChatUploadDeviceTypeTask(void);
	virtual ~LSLiveChatUploadDeviceTypeTask(void);
...
public:
	// 初始化参数
	bool InitParam(CLIENT_TYPE clientType);
