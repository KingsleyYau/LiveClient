 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatGetTalkInfoTask.h
 *   desc: 获取会话信息Task实现类
 */
...
class LSLiveChatGetTalkInfoTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetTalkInfoTask(void);
	virtual ~LSLiveChatGetTalkInfoTask(void);
