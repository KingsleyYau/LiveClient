 ...
 * author: Samson.Fan
 *   date: 2015-06-16
 *   file: LSLiveChatGetContactListTask.h
...
class LSLiveChatGetContactListTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetContactListTask(void);
	virtual ~LSLiveChatGetContactListTask(void);
...
public:
	// 初始化参数
	bool InitParam(CONTACT_LIST_TYPE listType);
...
private:
	...
	CONTACT_LIST_TYPE	m_listType;	// 请求的列表类型
};
