 ...
 * author: Samson.Fan
 *   date: 2016-03-23
 *   file: LSLiveChatRecvAutoInviteTask.h
...
class LSLiveChatRecvAutoInviteTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvAutoInviteTask(void);
	virtual ~LSLiveChatRecvAutoInviteTask(void);
