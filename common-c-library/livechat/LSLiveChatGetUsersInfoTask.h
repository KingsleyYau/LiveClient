 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatGetUsersInfoTask.h
...
class LSLiveChatGetUsersInfoTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetUsersInfoTask(void);
	virtual ~LSLiveChatGetUsersInfoTask(void);
...
public:
	// 初始化参数
	bool InitParam(const list<string>& userIdList);
