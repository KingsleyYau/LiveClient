 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatUseTryTicketTask.h
 *   desc: 使用试聊券Task实现类
 */
...
class LSLiveChatUseTryTicketTask : public ILSLiveChatTask
{
public:
	LSLiveChatUseTryTicketTask(void);
	virtual ~LSLiveChatUseTryTicketTask(void);
