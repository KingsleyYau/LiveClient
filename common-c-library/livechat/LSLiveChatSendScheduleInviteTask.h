 ...
 * author: Alex
 *   date: 2020-04 -07
 *   file: LSLiveChatSendScheduleInviteTask.h
...
using namespace std; 
class LSLiveChatSendScheduleInviteTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendScheduleInviteTask(void);
	virtual ~LSLiveChatSendScheduleInviteTask(void);
...
public:
	// 初始化参数
	bool InitParam(const LSLCScheduleInfoItem& item);
...
private:
    ...
    LSLCScheduleInfoItem m_scheduleItem; // 预约信息
