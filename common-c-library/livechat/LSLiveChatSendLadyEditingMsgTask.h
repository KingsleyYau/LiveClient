 ...
 * author: Samson.Fan
 *   date: 2015-03-25
 *   file: LSLiveChatSendLadyEditingMsgTask.h
...
class LSLiveChatSendLadyEditingMsgTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendLadyEditingMsgTask(void);
	virtual ~LSLiveChatSendLadyEditingMsgTask(void);
