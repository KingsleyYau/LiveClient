 ...
 * author: Samson.Fan
 *   date: 2016-04-25
 *   file: LSLiveChatRecvThemeMotionTask.h
...
class LSLiveChatRecvThemeMotionTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvThemeMotionTask(void);
	virtual ~LSLiveChatRecvThemeMotionTask(void);
