 ...
 * author: Alex.shum
 *   date: 2016-10-27
 *   file: LSLiveChatLadyAcceptCamInviteTask.h
...
class LSLiveChatLadyAcceptCamInviteTask : public ILSLiveChatTask
{
public:
	LSLiveChatLadyAcceptCamInviteTask(void);
	virtual ~LSLiveChatLadyAcceptCamInviteTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, CamshareLadyInviteType inviteType, int sessionId, const string& fromName, bool isOpenCam);
...
private:
	...
	string			m_userId;	  // CamShare对象ID
	string          m_camShareMsg; // CamShare回复信息
	bool            m_isOpenCam;   // Cam是否打开
};
