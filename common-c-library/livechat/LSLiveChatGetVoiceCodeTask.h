 ...
 * author: Samson.Fan
 *   date: 2015-03-25
 *   file: LSLiveChatGetVoiceCodeTask.h
...
class LSLiveChatGetVoiceCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetVoiceCodeTask(void);
	virtual ~LSLiveChatGetVoiceCodeTask(void);
