 ...
 * author: Samson.Fan
 *   date: 2015-06-16
 *   file: LSLiveChatGetRecentContactListTask.h
...
class LSLiveChatGetRecentContactListTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetRecentContactListTask(void);
	virtual ~LSLiveChatGetRecentContactListTask(void);
