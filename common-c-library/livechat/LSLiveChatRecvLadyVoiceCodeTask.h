 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvLadyVoiceCodeTask.h
...
class LSLiveChatRecvLadyVoiceCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvLadyVoiceCodeTask(void);
	virtual ~LSLiveChatRecvLadyVoiceCodeTask(void);
