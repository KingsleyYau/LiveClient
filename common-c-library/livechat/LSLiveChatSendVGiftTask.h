 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatSendVGiftTask.h
 *   desc: 发送虚拟礼物Task实现类
 */
...
class LSLiveChatSendVGiftTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendVGiftTask(void);
	virtual ~LSLiveChatSendVGiftTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, const string& giftId, int ticket);
