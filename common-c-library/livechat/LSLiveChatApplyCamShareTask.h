 ...
 * author: Alex.shum
 *   date: 2016-10-27
 *   file: LSLiveChatApplyCamShareTask.h
...
class LSLiveChatApplyCamShareTask : public ILSLiveChatTask
{
public:
	LSLiveChatApplyCamShareTask(void);
	virtual ~LSLiveChatApplyCamShareTask(void);
