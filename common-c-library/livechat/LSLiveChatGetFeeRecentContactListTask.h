 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: LSLiveChatGetFeeRecentContactListTask.h
...
class LSLiveChatGetFeeRecentContactListTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetFeeRecentContactListTask(void);
	virtual ~LSLiveChatGetFeeRecentContactListTask(void);
