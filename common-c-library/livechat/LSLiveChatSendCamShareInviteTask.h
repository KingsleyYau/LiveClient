 ...
 * author: Alex.shum
 *   date: 2016-10-27
 *   file: LSLiveChatSendCamShareInviteTask.h
...
class LSLiveChatSendCamShareInviteTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendCamShareInviteTask(void);
	virtual ~LSLiveChatSendCamShareInviteTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, CamshareInviteType inviteType, int sessionId, const string& fromName);
...
private:
	...
	string          m_camShareMsg; //CamShare邀请信息
};
