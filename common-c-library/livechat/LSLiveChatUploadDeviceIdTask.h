 ...
 * author: Samson.Fan
 *   date: 2015-03-31
 *   file: LSLiveChatUploadDeviceIdTask.h
 *   desc: 上传设备ID Task实现类
 */
...
class LSLiveChatUploadDeviceIdTask : public ILSLiveChatTask
{
public:
	LSLiveChatUploadDeviceIdTask(void);
	virtual ~LSLiveChatUploadDeviceIdTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& deviceId);
