 ...
 * author: Samson.Fan
 *   date: 2015-03-25
 *   file: LSLiveChatGetLadyVoiceCodeTask.h
...
class LSLiveChatGetLadyVoiceCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetLadyVoiceCodeTask(void);
	virtual ~LSLiveChatGetLadyVoiceCodeTask(void);
