 ...
 * author: Alex shum
 *   date: 2016-10-28
 *   file: LSLiveChatRecvManCamShareInviteTask.h
...
class LSLiveChatRecvManCamShareInviteTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvManCamShareInviteTask(void);
	virtual ~LSLiveChatRecvManCamShareInviteTask(void);
...
//	string	        m_msg;	 // 消息详情
    ...
    CamshareInviteType m_inviteType;
    int m_sessionId;
    string m_fromName;
