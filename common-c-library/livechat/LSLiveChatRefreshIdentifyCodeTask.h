 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: LSLiveChatRefreshIdentifyCodeTask.h
 *   desc: 刷新验证码Task实现类
 */
...
class LSLiveChatRefreshIdentifyCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRefreshIdentifyCodeTask(void);
	virtual ~LSLiveChatRefreshIdentifyCodeTask(void);
