 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: LSLiveChatRefreshInviteTemplateTask.h
 *   desc: 刷新邀请模板Task实现类
 */
...
class LSLiveChatRefreshInviteTemplateTask : public ILSLiveChatTask
{
public:
	LSLiveChatRefreshInviteTemplateTask(void);
	virtual ~LSLiveChatRefreshInviteTemplateTask(void);
