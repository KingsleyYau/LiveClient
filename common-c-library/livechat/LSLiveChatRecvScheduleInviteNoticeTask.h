 ...
 * author: Alex
 *   date: 2020-04-07
 *   file: LSLiveChatRecvScheduleInviteNoticeTask.h
...
class LSLiveChatRecvScheduleInviteNoticeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvScheduleInviteNoticeTask(void);
	virtual ~LSLiveChatRecvScheduleInviteNoticeTask(void);
