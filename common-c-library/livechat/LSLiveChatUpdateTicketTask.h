 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatUpdateTicketTask.h
 *   desc: 更新票根Task实现类
 */
...
class LSLiveChatUpdateTicketTask : public ILSLiveChatTask
{
public:
	LSLiveChatUpdateTicketTask(void);
	virtual ~LSLiveChatUpdateTicketTask(void);
