 ...
 * author: Samson.Fan
 *   date: 2016-04-08
 *   file: LSLiveChatSendMagicIconTask.h
 *   desc: 发送小高级表情Task实现类
 */
...
class LSLiveChatSendMagicIconTask : public ILSLiveChatTask
{
public:
	LSLiveChatSendMagicIconTask(void);
	virtual ~LSLiveChatSendMagicIconTask(void);
