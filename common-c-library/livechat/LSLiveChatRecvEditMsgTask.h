 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvEditMsgTask.h
...
class LSLiveChatRecvEditMsgTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvEditMsgTask(void);
	virtual ~LSLiveChatRecvEditMsgTask(void);
