 ...
 * author: Samson.Fan
 *   date: 2015-06-16
 *   file: LSLiveChatUploadVerTask.h
...
class LSLiveChatUploadVerTask : public ILSLiveChatTask
{
public:
	LSLiveChatUploadVerTask(void);
	virtual ~LSLiveChatUploadVerTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& ver);
