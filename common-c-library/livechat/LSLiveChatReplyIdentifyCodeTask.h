 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: LSLiveChatReplyIdentifyCodeTask.h
 *   desc: 回复验证码Task实现类
 */
...
class LSLiveChatReplyIdentifyCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatReplyIdentifyCodeTask(void);
	virtual ~LSLiveChatReplyIdentifyCodeTask(void);
...
public:
    // 初始化变量
    bool InitParam(const string& identifyCode);

private:
	ILSLiveChatClientListener*	m_listener;

	string m_identifyCode;
