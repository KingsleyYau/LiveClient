 ...
 * author: Samson.Fan
 *   date: 2015-08-04
 *   file: LSLiveChatRecvIdentifyCodeTask.h
 *   desc: 接收验证码Task实现类
 */
...
class LSLiveChatRecvIdentifyCodeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvIdentifyCodeTask(void);
	virtual ~LSLiveChatRecvIdentifyCodeTask(void);
