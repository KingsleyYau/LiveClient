 ...
 * author: Alex shum
 *   date: 2016-08-24
 *   file: LSLiveChatRecvManApplyThemeTask.h
...
class LSLiveChatRecvManApplyThemeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvManApplyThemeTask(void);
	virtual ~LSLiveChatRecvManApplyThemeTask(void);
