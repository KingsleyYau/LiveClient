 ...
 * author: Hunter.Mun
 *   date: 2016-12-6
 *   file: LSLiveChatGetSessionInfoTask.h
 *   desc: 获取会话信息Task实现类
 */
...
class LSLiveChatGetSessionInfoTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetSessionInfoTask(void);
	virtual ~LSLiveChatGetSessionInfoTask(void);
