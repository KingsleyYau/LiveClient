 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvEMFNoticeTask.h
...
class LSLiveChatRecvEMFNoticeTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvEMFNoticeTask(void);
	virtual ~LSLiveChatRecvEMFNoticeTask(void);
