 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatGetUserStatusTask.h
...
class LSLiveChatGetUserStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetUserStatusTask(void);
	virtual ~LSLiveChatGetUserStatusTask(void);
