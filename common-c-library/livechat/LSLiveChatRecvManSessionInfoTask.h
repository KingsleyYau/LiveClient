 ...
 * author: Hunter Mun
 *   date: 2017-03-02
 *   file: LSLiveChatRecvManSessionInfoTask.h
...
class LSLiveChatRecvManSessionInfoTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvManSessionInfoTask(void);
	virtual ~LSLiveChatRecvManSessionInfoTask(void);
