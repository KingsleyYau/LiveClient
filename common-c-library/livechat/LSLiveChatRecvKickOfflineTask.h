 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvKickOfflineTask.h
...
class LSLiveChatRecvKickOfflineTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvKickOfflineTask(void);
	virtual ~LSLiveChatRecvKickOfflineTask(void);
...
private:
	...
	KICK_OFFLINE_TYPE	m_kickType;	// 踢下线类型
};
