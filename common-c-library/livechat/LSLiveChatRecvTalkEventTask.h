 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvTalkEventTask.h
 *   desc: 接收聊天事件Task实现类
 */
...
class LSLiveChatRecvTalkEventTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvTalkEventTask(void);
	virtual ~LSLiveChatRecvTalkEventTask(void);
...
private:
	...
	TALK_EVENT_TYPE	m_eventType;// 事件类型
};
