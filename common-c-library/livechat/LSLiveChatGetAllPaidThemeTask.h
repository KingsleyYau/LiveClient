 ...
 * author: Samson.Fan
 *   date: 2016-04-25
 *   file: LSLiveChatGetAllPaidThemeTask.h
...
class LSLiveChatGetAllPaidThemeTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetAllPaidThemeTask(void);
	virtual ~LSLiveChatGetAllPaidThemeTask(void);
