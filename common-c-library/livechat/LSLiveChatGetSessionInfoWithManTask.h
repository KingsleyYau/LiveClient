 ...
 * author: Hunter Mun
 *   date: 2017-03-02
 *   file: LSLiveChatGetSessionInfoWithManTask.h
 *   desc: 女士端获取会话信息
 */
...
class LSLiveChatGetSessionInfoWithManTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetSessionInfoWithManTask(void);
	virtual ~LSLiveChatGetSessionInfoWithManTask(void);
