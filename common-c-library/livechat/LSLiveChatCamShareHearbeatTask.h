 ...
 * author: Alex.shum
 *   date: 2016-10-28
 *   file: LSLiveChatCamShareHearbeatTask.h
...
class  LSLiveChatCamShareHearbeatTask : public ILSLiveChatTask
{
public:
	 LSLiveChatCamShareHearbeatTask(void);
	virtual ~ LSLiveChatCamShareHearbeatTask(void);
