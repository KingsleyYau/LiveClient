 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatUpdateStatusTask.h
...
class LSLiveChatUpdateStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatUpdateStatusTask(void);
	virtual ~LSLiveChatUpdateStatusTask(void);
...
private:
	...
	USER_STATUS_TYPE	m_status;	// 在线状态
