 ...
 * author: Samson.Fan
 *   date: 2015-04-10
 *   file: LSLiveChatGetTalkListTask.h
...
class LSLiveChatGetTalkListTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetTalkListTask(void);
	virtual ~LSLiveChatGetTalkListTask(void);
...
public:
	// 初始化参数
	bool InitParam(unsigned int listType);
