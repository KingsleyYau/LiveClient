 ...
 * author: Samson.Fan
 *   date: 2015-06-16
 *   file: LSLiveChatGetBlockUsersTask.h
...
class LSLiveChatGetBlockUsersTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetBlockUsersTask(void);
	virtual ~LSLiveChatGetBlockUsersTask(void);
