 ...
 * author: Alex shum
 *   date: 2016-08-24
 *   file: LSLiveChatRecvLadyAutoInviteStatusTask.h
...
class LSLiveChatRecvLadyAutoInviteStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvLadyAutoInviteStatusTask(void);
	virtual ~LSLiveChatRecvLadyAutoInviteStatusTask(void);
