 ...
 * author: Samson.Fan
 *   date: 2015-04-11
 *   file: LSLiveChatRecvShowPhotoTask.h
 *   desc: 接收图片被查看Task实现类
 */
...
class LSLiveChatRecvShowPhotoTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvShowPhotoTask(void);
	virtual ~LSLiveChatRecvShowPhotoTask(void);
