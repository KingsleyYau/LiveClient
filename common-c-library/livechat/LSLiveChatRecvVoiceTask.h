 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvVoiceTask.h
 *   desc: 接收语音消息Task实现类
 */
...
class LSLiveChatRecvVoiceTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvVoiceTask(void);
	virtual ~LSLiveChatRecvVoiceTask(void);
