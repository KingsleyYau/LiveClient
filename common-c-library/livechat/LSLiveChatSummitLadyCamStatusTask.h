 ...
 * author: Hunter Mun
 *   date: 2017-03-02
 *   file: LSLiveChatSummitLadyCamStatusTask.h
...
class LSLiveChatSummitLadyCamStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatSummitLadyCamStatusTask(void);
	virtual ~LSLiveChatSummitLadyCamStatusTask(void);
...
public:
	// 初始化参数
	bool InitParam(CAMSHARE_STATUS_TYPE camshareStatus);
...
private:
	...
	CAMSHARE_STATUS_TYPE			m_camsharestatus;	// 聊天用户ID
};
