 ...
 * author: Samson.Fan
 *   date: 2016-04-25
 *   file: LSLiveChatManFeeThemeTask.h
 *   desc: 男士购买主题包Task实现类
 */
...
class LSLiveChatManFeeThemeTask : public ILSLiveChatTask
{
public:
	LSLiveChatManFeeThemeTask(void);
	virtual ~LSLiveChatManFeeThemeTask(void);
