 ...
 * author: Alex.shum
 *   date: 2016-10-27
 *   file: LSLiveChatGetLadyCamStatusTask.h
...
class LSLiveChatGetLadyCamStatusTask : public ILSLiveChatTask
{
public:
	LSLiveChatGetLadyCamStatusTask(void);
	virtual ~LSLiveChatGetLadyCamStatusTask(void);
