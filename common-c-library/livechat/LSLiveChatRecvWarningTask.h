 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvWarningTask.h
 *   desc: 接收警告消息Task实现类
 */
...
class LSLiveChatRecvWarningTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvWarningTask(void);
	virtual ~LSLiveChatRecvWarningTask(void);
