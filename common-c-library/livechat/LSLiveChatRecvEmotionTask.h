 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvEmotionTask.h
...
class LSLiveChatRecvEmotionTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvEmotionTask(void);
	virtual ~LSLiveChatRecvEmotionTask(void);
