 ...
 * author: Hunter Mun
 *   date: 2017-03-02
 *   file: LSLiveChatRecvManJoinOrExitConferenceTask.h
...
class LSLiveChatRecvManJoinOrExitConferenceTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvManJoinOrExitConferenceTask(void);
	virtual ~LSLiveChatRecvManJoinOrExitConferenceTask(void);
