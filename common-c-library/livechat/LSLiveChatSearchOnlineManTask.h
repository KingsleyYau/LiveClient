 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: LSLiveChatSearchOnlineManTask.h
 *   desc: 搜索在线男士Task实现类
 */
...
class LSLiveChatSearchOnlineManTask : public ILSLiveChatTask
{
public:
	LSLiveChatSearchOnlineManTask(void);
	virtual ~LSLiveChatSearchOnlineManTask(void);
