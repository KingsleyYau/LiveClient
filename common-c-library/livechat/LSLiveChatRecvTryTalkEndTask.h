 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: LSLiveChatRecvTryTalkEndTask.h
 *   desc: 接收试聊结束Task实现类
 */
...
class LSLiveChatRecvTryTalkEndTask : public ILSLiveChatTask
{
public:
	LSLiveChatRecvTryTalkEndTask(void);
	virtual ~LSLiveChatRecvTryTalkEndTask(void);
