...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.array.count > 0) {
        ...
        if (obj.anchorType == ANCHORTYPE_APPOINTANCHOR)
        {
            ...
            [[LSImageViewLoader loader] sdWebImageLoadView:cell.ladyHeadView options:0 imageUrl:obj.anchorPhotoUrl placeholderImage:[UIImage imageNamed:@"Default_Img_Lady_Circyle"] finishHandler:^(UIImage *image) {
