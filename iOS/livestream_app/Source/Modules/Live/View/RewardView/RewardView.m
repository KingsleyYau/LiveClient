...
#define RewardedTip @"Rewarded Coins: "
...
- (void)setupTimeAndCredit:(IMRebateItem *)item {
    ...
    self.item = item;
    self.creditNumLabel.text = [NSString stringWithFormat:@"%0.0f",item.curCredit];
...
- (void)updataCredit:(double)credit {
    self.creditNumLabel.text = [NSString stringWithFormat:@"%0.0f",credit];
}
