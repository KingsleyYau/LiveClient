...
- (void)setPriceNum:(CGFloat)num {
    ...
    NSString *priceStr = [NSString stringWithFormat:@"%@  %0.0f %@", NSLocalizedStringFromSelf(@"TOTAL_PRICE"), num, NSLocalizedStringFromSelf(@"CRDITS")];
    NSMutableAttributedString *mAttStr = [[NSMutableAttributedString alloc] initWithString:priceStr];

    NSRange priceRange = [priceStr rangeOfString:[NSString stringWithFormat:@"%0.0f", num]];
