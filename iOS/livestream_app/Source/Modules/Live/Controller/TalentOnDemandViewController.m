...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.subLabel.text = [NSString stringWithFormat:@"%0.0f %@", obj.credit, NSLocalizedString(@"COINS", @"COINS")];
...
- (void)requestBtnDid:(UIButton *)button {
    if (self.isSendTalent) {
        ...
        if (self.creditRebateManager.mCredit < obj.credit) {
            ...
            [self.tipView setPriceNum:[NSString stringWithFormat:@"%0.0f %@", obj.credit, NSLocalizedString(@"COINS", @"COINS")]];
