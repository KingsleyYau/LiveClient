...
//    navRightButton.frame = CGRectMake(0, 0, 30, 44);
...
- (void)viewDidLoad {
    ...
    if ([LSConfigManager manager].item.newestVer > buildID) {
        self.updateDialog.tipsLabel.text =[LSConfigManager manager].item.newestMsg;
    [self.updateDialog showDialog:AppDelegate().window cancelBlock:^{
