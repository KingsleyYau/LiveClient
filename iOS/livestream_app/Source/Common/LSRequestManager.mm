...
//        HttpClient::SetProxy("172.25.32.230", 8882);
    }
    return self;
}
...
class RequestOwnFackBookLoginCallbackImp : public IRequestOwnFackBookLoginCallback {
public:
    RequestOwnFackBookLoginCallbackImp(){};
    ~RequestOwnFackBookLoginCallbackImp(){};
    
    void OnOwnFackBookLogin(HttpOwnFackBookLoginTask* task, bool success, int errnum, const string& errmsg, const string& sessionId) {
        NSLog(@"LSRequestManager::OnOwnFackBookLogin( task : %p, success : %s, errnum : %d, errmsg : %s sessionId : %s)", task, success ? "true" : "false", errnum, errmsg.c_str(), sessionId.c_str());
        
        FackBookLoginFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
        ...
        if (handler) {
            handler(success, [[LSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], [NSString stringWithUTF8String:sessionId.c_str()]);
        }
    }
};
RequestOwnFackBookLoginCallbackImp gRequestOwnFackBookLoginCallbackImp;
- (NSInteger)fackBookLogin:(NSString * _Nonnull)fToken
    ...
    string fTokenStr = (fToken == nil ? "" : [fToken UTF8String]);
    string nickNameStr = (nickName == nil ? "" : [nickName UTF8String]);
    string utmReferrerStr = (utmReferrer == nil ? "" : [utmReferrer UTF8String]);
    string modelStr = (model == nil ? "" : [model UTF8String]);
    string deviceIdStr = (deviceId == nil ? "" : [deviceId UTF8String]);
    string manufacturerStr = (manufacturer == nil ? "" : [manufacturer UTF8String]);
    string inviteCodeStr = (inviteCode == nil ? "" : [inviteCode UTF8String]);
    string emailStr = (email == nil ? "" : [email UTF8String]);
    string passWordStr = (passWord == nil ? "" : [passWord UTF8String]);
    string birthDayStr = (birthDay == nil ? "" : [birthDay UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnFackBookLogin(&mHttpRequestManager, fTokenStr, nickNameStr, utmReferrerStr, modelStr, deviceIdStr, manufacturerStr, inviteCodeStr, emailStr, passWordStr, birthDayStr, gender, &gRequestOwnFackBookLoginCallbackImp);
...
class RequestOwnRegisterCallbackImp : public IRequestOwnRegisterCallback {
public:
    RequestOwnRegisterCallbackImp(){};
    ~RequestOwnRegisterCallbackImp(){};
    
    void OnOwnRegister(HttpOwnRegisterTask* task, bool success, int errnum, const string& errmsg, const string& sessionId) {
        NSLog(@"LSRequestManager::OnOwnRegister( task : %p, success : %s, errnum : %d, errmsg : %s sessionId : %s)", task, success ? "true" : "false", errnum, errmsg.c_str(), sessionId.c_str());
        
        MailRegisterFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestOwnRegisterCallbackImp gRequestOwnRegisterCallbackImp;
- (NSInteger)mailRegister:(NSString * _Nonnull)email
    ...
    string manufacturerStr = (manufacturer == nil ? "" : [manufacturer UTF8String]);
    string utmReferrerStr = (utmReferrer == nil ? "" : [utmReferrer UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnRegister(&mHttpRequestManager, emailStr, passWordStr, gender, nickNameStr, birthDayStr, inviteCodeStr, modelStr, deviceidStr, manufacturerStr, utmReferrerStr, &gRequestOwnRegisterCallbackImp);
...
class RequestOwnEmailLoginCallbackImp : public IRequestOwnEmailLoginCallback {
public:
    RequestOwnEmailLoginCallbackImp(){};
    ~RequestOwnEmailLoginCallbackImp(){};
    
    void OnOwnEmailLogin(HttpOwnEmailLoginTask* task, bool success, int errnum, const string& errmsg, const string& sessionId) {
        NSLog(@"LSRequestManager::OnOwnEmailLogin( task : %p, success : %s, errnum : %d, errmsg : %s sessionId : %s)", task, success ? "true" : "false", errnum, errmsg.c_str(), sessionId.c_str());
        
        EmailLoginFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestOwnEmailLoginCallbackImp gRequestOwnEmailLoginCallbackImp;
- (NSInteger)emailLogin:(NSString * _Nonnull)email
    ...
    string deviceidStr = (deviceid == nil ? "" : [deviceid UTF8String]);
    string manufacturerStr = (manufacturer == nil ? "" : [manufacturer UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnEmailLogin(&mHttpRequestManager, emailStr, passWordStr, modelStr, deviceidStr, manufacturerStr, &gRequestOwnEmailLoginCallbackImp);
...
class RequestOwnFindPasswordCallbackImp : public IRequestOwnFindPasswordCallback {
public:
    RequestOwnFindPasswordCallbackImp(){};
    ~RequestOwnFindPasswordCallbackImp(){};
    
    void OnOwnFindPassword(HttpOwnFindPasswordTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnOwnFindPassword( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
RequestOwnFindPasswordCallbackImp gRequestOwnFindPasswordCallbackImp;
- (NSInteger)findPassword:(NSString * _Nonnull)sendMail
    ...
    string sendMailStr = (sendMail == nil ? "" : [sendMail UTF8String]);
    string checkCodeStr = (checkCode == nil ? "" : [checkCode UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnFindPassword(&mHttpRequestManager, sendMailStr, checkCodeStr, &gRequestOwnFindPasswordCallbackImp);
...
class RequestOwnCheckMailRegistrationCallbackImp : public IRequestOwnCheckMailRegistrationCallback {
public:
    RequestOwnCheckMailRegistrationCallbackImp(){};
    ~RequestOwnCheckMailRegistrationCallbackImp(){};
    
    void OnOwnCheckMailRegistration(HttpOwnCheckMailRegistrationTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnOwnCheckMailRegistration( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        
        CheckMailFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestOwnCheckMailRegistrationCallbackImp gRequestOwnCheckMailRegistrationCallbackImp;
- (NSInteger)checkMail:(NSString * _Nonnull)email
         finishHandler:(CheckMailFinishHandler _Nullable)finishHandler {
    string emailStr = (email == nil ? "" : [email UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnCheckMail(&mHttpRequestManager, emailStr, &gRequestOwnCheckMailRegistrationCallbackImp);
...
class RequestUploadPhotoCallbackImp : public IRequestUploadPhotoCallback {
public:
    RequestUploadPhotoCallbackImp(){};
    ~RequestUploadPhotoCallbackImp(){};
    
    void OnUploadPhoto(HttpUploadPhotoTask* task, bool success, int errnum, const string& errmsg, const string& photoUrl) {
        NSLog(@"LSRequestManager::OnUploadPhoto( task : %p, success : %s, errnum : %d, errmsg : %s  photoUrl: %s)", task, success ? "true" : "false", errnum, errmsg.c_str(), photoUrl.c_str());
        
        UploadPhotoFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
        ...
        if (handler) {
            handler(success, [[LSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], [NSString stringWithUTF8String:photoUrl.c_str()]);
        }
    }
};
RequestUploadPhotoCallbackImp gRequestUploadPhotoCallbackImp;
- (NSInteger)uploadPhoto:(NSString * _Nonnull)photoName
           finishHandler:(UploadPhotoFinishHandler _Nullable)finishHandler {
    string photoNameStr = (photoName == nil ? "" : [photoName UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.OwnUploadPhoto(&mHttpRequestManager, photoNameStr, &gRequestUploadPhotoCallbackImp);
...
class RequestGetVerificationCodeCallbackImp : public IRequestGetVerificationCodeCallback {
public:
    RequestGetVerificationCodeCallbackImp(){};
    ~RequestGetVerificationCodeCallbackImp(){};
    ...
    void OnGetVerificationCode(HttpGetVerificationCodeTask* task, bool success, int errnum, const string& errmsg, const char* data, int len) {
        NSLog(@"LSRequestManager::OnGetVerificationCode( task : %p, success : %s, errnum : %d, errmsg : %s len :%d ", task, success ? "true" : "false", errnum, errmsg.c_str(), len);
        
        GetVerificationCodeFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestGetVerificationCodeCallbackImp gRequestGetVerificationCodeCallbackImp;
- (NSInteger)getVerificationCode:(VerifyCodeType)verifyType
    ...
    NSInteger request = (NSInteger)mHttpRequestController.GetVerificationCode(&mHttpRequestManager, verifyType, useCode, &gRequestGetVerificationCodeCallbackImp);
...
public:
    ...
    void OnGetConfig(HttpGetConfigTask *task, bool success, int errnum, const string &errmsg, const HttpConfigItem &configItem) {
        ...
        obj.termsOfUse = [NSString stringWithUTF8String:configItem.termsOfUse.c_str()];
        obj.privacyPolicy = [NSString stringWithUTF8String:configItem.privacyPolicy.c_str()];
        ...
        NSMutableArray *array = [NSMutableArray array];
        for (HttpLoginItem::SvrList::const_iterator iter = configItem.svrList.begin(); iter != configItem.svrList.end(); iter++) {
            LSSvrItemObject *svrItem = [[LSSvrItemObject alloc] init];
            svrItem.svrId = [NSString stringWithUTF8String:(*iter).svrId.c_str()];
            svrItem.tUrl = [NSString stringWithUTF8String:(*iter).tUrl.c_str()];
            [array addObject:svrItem];
...
class RequestGetShareLinkCallbackImp : public IRequestGetShareLinkCallback {
public:
    RequestGetShareLinkCallbackImp(){};
    ~RequestGetShareLinkCallbackImp(){};
    void OnGetShareLink(HttpGetShareLinkTask* task, bool success, int errnum, const string& errmsg, const string& shareId, const string& shareLink) {
        NSLog(@"LSRequestManager::OnGetShareLink( task : %p, success : %s, errnum : %d, errmsg : %s shareId : %s shareLink : %s )", task, success ? "true" : "false", errnum, errmsg.c_str(), shareId.c_str(), shareLink.c_str());
        
        GetShareLinkFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
        ...
        if (handler) {
            handler(success, [[LSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], [NSString stringWithUTF8String:shareId.c_str()], [NSString stringWithUTF8String:shareLink.c_str()]);
        }
    }
};

RequestGetShareLinkCallbackImp gRequestGetShareLinkCallbackImp;
- (NSInteger)getShareLink:(NSString * _Nonnull) shareuserId
    ...
    string shareuserIdStr = (shareuserId == nil ? "" : [shareuserId UTF8String]);
    string anchorIdStr = (anchorId == nil ? "" : [anchorId UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.GetShareLink(&mHttpRequestManager, shareuserIdStr, anchorIdStr, shareType, sharePageType, &gRequestGetShareLinkCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestSetShareSucCallbackImp : public IRequestSetShareSucCallback {
public:
    RequestSetShareSucCallbackImp(){};
    ~RequestSetShareSucCallbackImp(){};
    void OnSetShareSuc(HttpSetShareSucTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnSetShareSuc( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        
        SetShareSucFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestSetShareSucCallbackImp gRequestSetShareSucCallbackImp;
- (NSInteger)setShareSuc:(NSString * _Nonnull) shareId
           finishHandler:(SetShareSucFinishHandler _Nullable)finishHandler {
    string shareIdStr = (shareId == nil ? "" : [shareId UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.SetShareSuc(&mHttpRequestManager, shareIdStr, &gRequestSetShareSucCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestSubmitFeedBackCallbackImp : public IRequestSubmitFeedBackCallback {
public:
    RequestSubmitFeedBackCallbackImp(){};
    ~RequestSubmitFeedBackCallbackImp(){};
    void OnSubmitFeedBack(HttpSubmitFeedBackTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnSubmitFeedBack( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        
        SubmitFeedBackFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestSubmitFeedBackCallbackImp gRequestSubmitFeedBackCallbackImp;
- (NSInteger)submitFeedBack:(NSString * _Nonnull) mail
    ...
    string mailStr = (mail == nil ? "" : [mail UTF8String]);
    string msgStr = (msg == nil ? "" : [msg UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.SubmitFeedBack(&mHttpRequestManager, mailStr, msgStr, &gRequestSubmitFeedBackCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestGetManBaseInfoCallbackImp : public IRequestGetManBaseInfoCallback {
public:
    RequestGetManBaseInfoCallbackImp(){};
    ~RequestGetManBaseInfoCallbackImp(){};
    void OnGetManBaseInfo(HttpGetManBaseInfoTask* task, bool success, int errnum, const string& errmsg, const HttpManBaseInfoItem& infoItem) {
        NSLog(@"LSRequestManager::OnGetManBaseInfo( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        
        LSManBaseInfoItemObject * item = [[LSManBaseInfoItemObject alloc] init];
        item.userId = [NSString stringWithUTF8String:infoItem.userId.c_str()];
        item.nickName = [NSString stringWithUTF8String:infoItem.nickName.c_str()];
        item.nickNameStatus = infoItem.nickNameStatus;
        item.photoUrl = [NSString stringWithUTF8String:infoItem.photoUrl.c_str()];
        item.photoStatus = infoItem.photoStatus;
        item.birthday = [NSString stringWithUTF8String:infoItem.birthday.c_str()];
        item.userlevel = infoItem.userlevel;
        item.gender = infoItem.gender;
        item.userType = infoItem.userType;
        item.gaUid = [NSString stringWithUTF8String:infoItem.gaUid.c_str()];
        
        GetManBaseInfoFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestGetManBaseInfoCallbackImp gRequestGetManBaseInfoCallbackImp;
- (NSInteger)getManBaseInfo:(GetManBaseInfoFinishHandler _Nullable)finishHandler {
    NSInteger request = (NSInteger)mHttpRequestController.GetManBaseInfo(&mHttpRequestManager,&gRequestGetManBaseInfoCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestSetManBaseInfoCallbackImp : public IRequestSetManBaseInfoCallback {
public:
    RequestSetManBaseInfoCallbackImp(){};
    ~RequestSetManBaseInfoCallbackImp(){};
    void OnSetManBaseInfo(HttpSetManBaseInfoTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnSetManBaseInfo( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());

        SetManBaseInfoFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestSetManBaseInfoCallbackImp gRequestSetManBaseInfoCallbackImp;
- (NSInteger)setManBaseInfo:(NSString * _Nonnull)nickName
              finishHandler:(SetManBaseInfoFinishHandler _Nullable)finishHandler {
    string nickNameStr = (nickName == nil ? "" : [nickName UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.SetManBaseInfo(&mHttpRequestManager, nickNameStr, &gRequestSetManBaseInfoCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestCrashFileCallbackImp : public IRequestCrashFileCallback {
public:
    RequestCrashFileCallbackImp(){};
    ~RequestCrashFileCallbackImp(){};
    void OnCrashFile(HttpCrashFileTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnCrashFile( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        
        UploadCrashFileFinishHandler handler = nil;
        LSRequestManager *manager = [LSRequestManager manager];
        @synchronized(manager.delegateDictionary) {
            handler = [manager.delegateDictionary objectForKey:@((NSInteger)task)];
            [manager.delegateDictionary removeObjectForKey:@((NSInteger)task)];
...
RequestCrashFileCallbackImp gRequestCrashFileCallbackImp;
- (NSInteger)uploadCrashFile:(NSString * _Nonnull)deviceId
    ...
    if (bFlag) {
        string deviceIdStr = (deviceId == nil ? "" : [deviceId UTF8String]);
        request = (NSInteger)mHttpRequestController.CrashFile(&mHttpRequestManager, deviceIdStr, pZipFileName, &gRequestCrashFileCallbackImp);
        if (request != HTTPREQUEST_INVALIDREQUESTID) {
            @synchronized(self.delegateDictionary) {
                [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
            }
...
class RequestPremiumMembershipCallbackImp : public IRequestPremiumMembershipCallback {
public:
    RequestPremiumMembershipCallbackImp(){};
    ~RequestPremiumMembershipCallbackImp(){};
    void OnPremiumMembership(HttpPremiumMembershipTask* task, bool success, int errnum, const string& errmsg, const HttpOrderProductItem& productItem) {
        NSLog(@"LSRequestManager::OnPremiumMembership( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        for (ProductItemList::const_iterator iter = productItem.list.begin(); iter != productItem.list.end(); iter++) {
            ...
            objProduct.icon = [NSString stringWithUTF8String:(*iter).icon.c_str()];
...
RequestPremiumMembershipCallbackImp gRequestPremiumMembershipCallbackImp;

- (NSInteger)premiumMembership:(NSString * _Nonnull) siteId
                 finishHandler:(PremiumMembershipFinishHandler _Nullable)finishHandler {
    string siteIdStr = (siteId == nil ? "" : [siteId UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.PremiumMembership(&mHttpRequestManager, siteIdStr, &gRequestPremiumMembershipCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestGetIOSPayCallbackImp : public IRequestGetIOSPayCallback {
public:
    RequestGetIOSPayCallbackImp(){};
    ~RequestGetIOSPayCallbackImp(){};
    void OnGetIOSPay(HttpGetIOSPayTask* task, bool success, const string& code, const string& orderNo, const string& productId) {
...
RequestGetIOSPayCallbackImp gRequestGetIOSPayCallbackImp;
...
- (NSInteger)getIOSPay:(NSString * _Nonnull) manid
    ...
    string siteidStr = (siteid == nil ? "" : [siteid UTF8String]);
    NSInteger request = (NSInteger)mHttpRequestController.GetIOSPay(&mHttpRequestManager, manidStr, sidStr, numberStr, siteidStr, &gRequestGetIOSPayCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
...
class RequestIOSPayCallCallbackImp : public IRequestIOSPayCallCallback {
public:
    RequestIOSPayCallCallbackImp(){};
    ~RequestIOSPayCallCallbackImp(){};
    void OnIOSPayCall(HttpIOSPayCallTask* task, bool success, const string& code) {
...
RequestIOSPayCallCallbackImp gRequestIOSPayCallCallbackImp;

//- (NSInteger)iOSPayCall:(NSString * _Nonnull) manid
//                    sid:(NSString * _Nonnull) sid
//                 number:(NSString * _Nonnull) receipt
//                 siteid:(NSString * _Nonnull) orderNo
...
- (NSInteger)iOSPayCall:(NSString * _Nonnull) manid
    ...
    NSInteger request = (NSInteger)mHttpRequestController.IOSPayCall(&mHttpRequestManager, manidStr, sidStr, receiptStr, orderNoStr, code, &gRequestIOSPayCallCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@((NSInteger)request)];
        }
