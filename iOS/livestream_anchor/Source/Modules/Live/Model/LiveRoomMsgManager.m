...
//            break;
    ...
    // 拼送礼图片
    if (item.msgType == MsgType_Gift || item.msgType == MsgType_RiderJoin) {
        ...
        if (item.msgType == MsgType_Gift) {
            ...
            [self.loader loadImageWithImageView:imageView options:0 imageUrl:item.riderUrl placeholderImage:
             [UIImage imageNamed:@"Live_Rider_Normal"]];
        }
