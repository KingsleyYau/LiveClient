        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (success) {
                ...
                for (int i = 0; i < item.count; i++) {
                    ZBEmoticonItemObject *object = item[i];
                    ...
                    for (ZBEmoticonInfoItemObject *infoItem in object.emoList) {
...
- (void)downLoadListEmotionWithItem:(ChatEmotionItem *)item andUrl:(NSString *)url emotionType:(ZBEmoticonType)type index:(NSInteger)index {
