...
/**
 ...
 The animation can be played by LSYYAnimatedImageView.
 ...
 Sample Code:
    ...
    LSYYSpriteSheetImage *sprite;
    sprite = [[LSYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    LSYYAnimatedImageView *imgView = [LSYYAnimatedImageView new];
