...
static ZBLSRequestManager *gManager = nil;
@interface ZBLSRequestManager () {
...
@implementation ZBLSRequestManager
...
//        mConfigHttpRequestManager.SetVersionCode(COMMON_VERSION_CODE, [self.versionCode UTF8String]);
        mHttpRequestManager.SetVersionCode(COMMON_VERSION_CODE, "100");
        mConfigHttpRequestManager.SetVersionCode(COMMON_VERSION_CODE, "100");
...
public:
    ...
    void OnZBLogin(ZBHttpLoginTask* task, bool success, int errnum, const string& errmsg, const ZBHttpLoginItem& item) {
        NSLog(@"ZBLSRequestManager::OnZBLogin( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], obj);
        }
    }
};
...
public:
    ...
    void OnZBUpdateTokenId(ZBHttpUpdateTokenIdTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnZBUpdateTokenId( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()]);
        }
    }
};
...
public:
    ...
    void OnZBGetVerificationCode(ZBHttpGetVerificationCodeTask* task, bool success, int errnum, const string& errmsg, const char* data, int len) {
        NSLog(@"LSRequestManager::OnZBGetVerificationCode( task : %p, success : %s, errnum : %d, errmsg : %s len :%d ", task, success ? "true" : "false", errnum, errmsg.c_str(), len);
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], data, len);
        }
    }
};
...
public:
    ...
    void OnZBLiveFansList(ZBHttpLiveFansListTask* task, bool success, int errnum, const string& errmsg, const ZBHttpLiveFansList& listItem) {
        NSLog(@"LSRequestManager::OnZBLiveFansList( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], array);
        }
    }
};
...
public:
    ...
    void OnZBGetGiftDetail(ZBHttpGetGiftDetailTask* task, bool success, int errnum, const string& errmsg, const ZBHttpGiftInfoItem& item) {
        NSLog(@"LSRequestManager::OnZBGetGiftDetail( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], gift);
        }
    }
};
...
public:
    ...
    void OnZBGetEmoticonList(ZBHttpGetEmoticonListTask* task, bool success, int errnum, const string& errmsg, const ZBEmoticonItemList& listItem) {
        NSLog(@"LSRequestManager::OnZBGetEmoticonList( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBDealTalentRequest(ZBHttpDealTalentRequestTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::ZBDealTalentRequest( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBSetAutoPush(ZBHttpSetAutoPushTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnZBSetAutoPush( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBManHandleBookingList(ZBHttpManHandleBookingListTask* task, bool success, int errnum, const string& errmsg, const ZBHttpBookingInviteListItem& BookingListItem) {
        NSLog(@"LSRequestManager::OnZBManHandleBookingList( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], item);
        }
    }
};
...
public:
    ...
    void OnZBAcceptScheduledInvite(ZBHttpAcceptScheduledInviteTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnAcceptScheduledInvite( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBRejectScheduledInvite(ZBHttpRejectScheduledInviteTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnRejectScheduledInvit( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBGetScheduleListNoReadNum(ZBHttpManBookingUnreadUnhandleNumTask* task, bool success, int errnum, const string& errmsg, const ZBHttpBookingUnreadUnhandleNumItem& item) {
        NSLog(@"LSRequestManager::OnGetScheduleListNoReadNum( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBGetScheduledAcceptNum(ZBHttpGetScheduledAcceptNumTask* task, bool success, int errnum, const string& errmsg, const int scheduledNum) {
        NSLog(@"LSRequestManager::OnGetScheduledAcceptNum( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], scheduledNum);
        }
    }
};
...
public:
    ...
    void OnZBAcceptInstanceInvite(ZBHttpAcceptInstanceInviteTask* task, bool success, int errnum, const string& errmsg, const string& roomId, ZBHttpRoomType roomType){
        ...
        if (handler) {
            handler(success, [[ZBLSRequestManager manager] intToHttpLccErrType:errnum], [NSString stringWithUTF8String:errmsg.c_str()], [NSString stringWithUTF8String:roomId.c_str()], roomType);
        }
    }
};
...
public:
    ...
    void OnZBRejectInstanceInvite(ZBHttpRejectInstanceInviteTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnRejectInstanceInvite( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBCancelInstantInviteUser(ZBHttpCancelInstantInviteUserTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnCancelInstantInvite( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
public:
    ...
    void OnZBSetRoomCountDown(ZBHttpSetRoomCountDownTask* task, bool success, int errnum, const string& errmsg) {
        NSLog(@"LSRequestManager::OnZBSetRoomCountDown( task : %p, success : %s, errnum : %d, errmsg : %s )", task, success ? "true" : "false", errnum, errmsg.c_str());
...
- (NSInteger)anchorGetTodayCredit:(ZBGetTodayCreditFinishHandler _Nullable)finishHandler {
    ...
    NSInteger request = (NSInteger)mHttpRequestController.ZBGetTodayCredit(&mConfigHttpRequestManager, &gRequestZBGetTodayCreditCallbackImp);
    if (request != HTTPREQUEST_INVALIDREQUESTID) {
        @synchronized(self.delegateDictionary) {
            [self.delegateDictionary setObject:finishHandler forKey:@(request)];
        }
