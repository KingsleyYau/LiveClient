...
@implementation LSSayHiGetAnchorListRequest
- (instancetype)init{
    if (self = [super init]) {
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getSayHiAnchorList:^(BOOL success, HTTP_LCC_ERR_TYPE errnum, NSString *errmsg, NSArray *array) {
            BOOL bFlag = NO;
