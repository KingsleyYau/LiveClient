...
//  RtmpClientTest
//
//  Created by Max on 2021/1/6.
//  Copyright © 2021 net.qdating. All rights reserved.
//

#import "LSImageMovie.h"

@interface LSImageMovie () <AVPlayerItemOutputPullDelegate> {
...
- (void)startProcessing {
    ...
    LSImageMovie __block *blockSelf = self;

    [inputAsset loadValuesAsynchronouslyForKeys:[NSArray arrayWithObject:@"tracks"]
                              completionHandler:^{
                                  dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
                                      ...
                                      [blockSelf.delegate didLoadPlayingMovie];
...
- (void)processAsset {
    ...
    __unsafe_unretained LSImageMovie *weakSelf = self;
