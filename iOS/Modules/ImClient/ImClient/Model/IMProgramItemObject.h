...
@interface IMProgramItemObject : NSObject
...
@property (nonatomic, assign) IMProgramStatus status;
@property (nonatomic, assign) IMProgramTicketStatus ticketStatus;
