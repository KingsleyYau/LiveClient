...
//
//  IMAnchorRecvEnterRoomItemObject.h
//  livestream
//
...
@interface IMAnchorRecvEnterRoomItemObject : NSObject
...
@property (nonatomic, strong) IMAnchorUserInfoItemObject *_Nonnull userInfo;
@property (nonatomic, strong) NSArray<NSString *> *_Nonnull pullUrl;
@property (nonatomic, strong) NSArray<AnchorGiftNumItemObject *> *_Nonnull bugForList;
@end
