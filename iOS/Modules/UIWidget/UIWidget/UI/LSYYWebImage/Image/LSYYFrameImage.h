...
/**
 ...
 Sample Code:
     ...
     LSYYFrameImage *image = [LSYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     LSYYAnimatedImageView *imageView = [LSYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface LSYYFrameImage : UIImage <YYAnimatedImage>
...
/**
 ...
 @return An initialized LSYYFrameImage object, or nil when an error occurs.
 */
