//
//  GetLiveRoomAllGiftListRequest.m
//  dating
//
...
@implementation GetLiveRoomAllGiftListRequest
- (instancetype)init{
    if (self = [super init]) {
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getLiveRoomAllGiftList:self.token finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, NSArray<LiveRoomGiftItemObject *> * _Nullable array) {
            BOOL bFlag = NO;
