...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getFollowList:self.start step:self.step finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, NSArray<FollowItemObject *>* _Nullable array)  {
            BOOL bFlag = NO;
