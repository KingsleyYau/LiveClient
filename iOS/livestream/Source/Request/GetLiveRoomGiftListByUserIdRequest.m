//
//  GetLiveRoomGiftListByUserIdRequest.m
//  dating
//
...
@implementation GetLiveRoomGiftListByUserIdRequest
- (instancetype)init{
    if (self = [super init]) {
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getLiveRoomGiftListByUserId:self.token roomId:self.roomId finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, NSArray<NSString *> * _Nullable array) {
            BOOL bFlag = NO;
