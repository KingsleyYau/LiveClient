...
@interface LSProgramItemObject () <NSCoding>
@end


@implementation LSProgramItemObject
...
- (id)init {
    if( self = [super init] ) {
        ...
        self.price = 0.0;
        self.status = PROGRAMSTATUS_UNKNOW;
        self.ticketStatus = PROGRAMTICKETSTATUS_UNKNOW;
        self.isHasFollow = NO;
