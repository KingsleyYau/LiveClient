...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getLeftCredit:^(BOOL success, HTTP_LCC_ERR_TYPE errnum, NSString *errmsg, LSLeftCreditItemObject *item)  {
            BOOL bFlag = NO;
...
- (void)callRespond:(BOOL)success errnum:(HTTP_LCC_ERR_TYPE)errnum errmsg:(NSString* _Nullable)errmsg {
    if( self.finishHandler && !success ) {
        LSLeftCreditItemObject *item = [[LSLeftCreditItemObject alloc] init];
