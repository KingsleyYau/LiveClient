//
//  UpdateLiveRoomTokenIdRequest.m
//  dating
//
...
#import "UpdateLiveRoomTokenIdRequest.h"

@implementation UpdateLiveRoomTokenIdRequest
- (instancetype)init{
    if (self = [super init]) {
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager updateLiveRoomTokenId:self.token tokenId:self.tokenId finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg) {
            BOOL bFlag = NO;
