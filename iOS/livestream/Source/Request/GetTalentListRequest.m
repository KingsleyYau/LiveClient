...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getTalentList:self.roomId finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, NSArray<GetTalentItemObject *> * _Nonnull array) {
            BOOL bFlag = NO;
