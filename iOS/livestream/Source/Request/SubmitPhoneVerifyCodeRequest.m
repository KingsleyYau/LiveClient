...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager submitPhoneVerifyCode:self.country areaCode:self.areaCode phoneNo:self.phoneNo verifyCode:self.verifyCode finishHandler:^(BOOL success, HTTP_LCC_ERR_TYPE errnum, NSString * _Nonnull errmsg) {
            BOOL bFlag = NO;
