...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getTalentStatus:self.roomId talentInviteId:self.talentInviteId finishHandler:^(BOOL success, HTTP_LCC_ERR_TYPE errnum, NSString * _Nonnull errmsg, GetTalentStatusItemObject * _Nonnull item) {
            BOOL bFlag = NO;
