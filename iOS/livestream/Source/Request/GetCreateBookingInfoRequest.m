...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getCreateBookingInfo:self.userId finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, GetCreateBookingInfoItemObject * _Nonnull item) {
            BOOL bFlag = NO;
