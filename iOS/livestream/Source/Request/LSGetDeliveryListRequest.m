...
@implementation LSGetDeliveryListRequest
- (instancetype)init{
    if (self = [super init]) {
    }
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getDeliveryList:^(BOOL success, HTTP_LCC_ERR_TYPE errnum, NSString *errmsg, NSArray<LSDeliveryItemObject *> *array) {
            BOOL bFlag = NO;
