//
//  GetLiveRoomGiftDetailRequest.m
//  dating
//
...
@implementation GetLiveRoomGiftDetailRequest
- (instancetype)init{
    if (self = [super init]) {
...
- (BOOL)sendRequest {
    if( self.manager ) {
        ...
        NSInteger request = [self.manager getLiveRoomGiftDetail:self.token giftId:self.giftId finishHandler:^(BOOL success, NSInteger errnum, NSString * _Nonnull errmsg, LiveRoomGiftItemObject * _Nullable item) {
            BOOL bFlag = NO;
