//
//  ChatEmotionChooseCollectionViewLayout.m
//  dating
//
...
@interface ChatEmotionChooseCollectionViewLayout ()
...
@implementation ChatEmotionChooseCollectionViewLayout
...
- (void)prepareLayout {
    ...
    self.itemSize = 35;
    self.itemSpace = (SCREEN_WIDTH - 210) / 7;
