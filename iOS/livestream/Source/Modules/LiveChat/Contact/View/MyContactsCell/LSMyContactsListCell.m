...
- (void)setFavoitesCellMoreView:(LSRecommendAnchorItemObject *)item {
    ...
    [self.imageViewLoader loadImageFromCache:self.ladyHead options:0 imageUrl:item.anchorAvatar placeholderImage:LADYDEFAULTIMG finishHandler:^(UIImage *image) {
    }];
