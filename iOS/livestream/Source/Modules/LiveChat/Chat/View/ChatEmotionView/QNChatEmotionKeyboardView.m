...
@interface QNChatEmotionKeyboardView ()
@property (nonatomic,strong) UIView* selectedButtonBackgroundView;
@property (nonatomic,assign) BOOL isShowed;
@end

@implementation QNChatEmotionKeyboardView
+ (instancetype)chatEmotionKeyboardView:(id)owner {
    NSArray *nibs = [[LiveBundle mainBundle] loadNibNamedWithFamily:@"QNChatEmotionKeyboardView" owner:owner options:nil];
    QNChatEmotionKeyboardView* view = [nibs objectAtIndex:0];
