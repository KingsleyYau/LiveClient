...
- (void)loadUser:(LSLCLiveChatUserItemObject *)user msg:(NSString *)msg msgItem:(LSLCLiveChatMsgItemObject *)item
{
    ...
    // 加载
    [self.imageViewLoader loadImageWithImageView:self.ladyImageView options:SDWebImageRefreshCached imageUrl:user.imageUrl placeholderImage:[UIImage imageNamed:@"Default_Img_Lady_Circyle"]];
