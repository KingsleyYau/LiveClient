...
#import "LSPhizCollectionView.h"

@interface LSPhizCollectionView ()
@property (nonatomic,strong) UIView* selectedButtonBackgroundView;
@property (nonatomic,assign) BOOL isShowed;
@end

@implementation LSPhizCollectionView

+ (instancetype)LSPageChooseKeyboardView:(id)owner {
    NSArray *nibs = [[LiveBundle mainBundle] loadNibNamedWithFamily:@"LSPhizCollectionView" owner:owner options:nil];
    LSPhizCollectionView* view = [nibs objectAtIndex:0];
