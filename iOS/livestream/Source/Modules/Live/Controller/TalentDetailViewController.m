...
- (void)viewDidLoad {
    ...
    [[LSImageViewLoader loader] loadImageWithImageView:headImage options:0 imageUrl:self.liveRoom.photoUrl placeholderImage:[UIImage imageNamed:@"Default_Img_Lady_Circyle"]];
