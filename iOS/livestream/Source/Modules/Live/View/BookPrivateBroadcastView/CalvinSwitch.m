...
#define SwitchMaxHeight 80.0f
#define SwitchMinHeight 20.0f

#define SwitchMinWidth 40.0f

@interface CalvinSwitch ()
...
- (CGRect)roundRect:(CGRect)frameOrBounds
{
    ...
    if (newRect.size.height > SwitchMaxHeight) {
        newRect.size.height = SwitchMaxHeight;
    }
    
    if (newRect.size.height < SwitchMinHeight) {
        newRect.size.height = SwitchMinHeight;
    }
    
    if (newRect.size.width < SwitchMinWidth) {
