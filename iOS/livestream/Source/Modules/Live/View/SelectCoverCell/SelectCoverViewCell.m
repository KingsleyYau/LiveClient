...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _deleteBtn.frame = CGRectMake(self.width - 26, 0, 29, 29);
        ...
        _userButton.frame = CGRectMake((self.width-DESGIN_TRANSFORM_3X(80))*0.5, self.width+DESGIN_TRANSFORM_3X(5), DESGIN_TRANSFORM_3X(80), DESGIN_TRANSFORM_3X(20));
        ...
        _maskView.backgroundColor = [UIColor colorWithWhite:1.000 alpha:0.7];
...
- (void)setCellCoverImage:(CoverPhotoItemObject *)object{
    ...
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:nil options:0 completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
