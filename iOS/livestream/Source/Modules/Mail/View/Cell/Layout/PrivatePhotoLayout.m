...
#import "PrivatePhotoLayout.h"

@interface PrivatePhotoLayout ()
...
@implementation PrivatePhotoLayout
- (instancetype)init {
    if (self = [super init]) {
        // 页数当前页的初始化
        self.currentPage = 0;
...
- (void)prepareLayout {
    ...
    self.itemSize = 0;
    self.itemWidth = (self.collectionView.frame.size.width - 16) / 3;
    self.itemHeight = (self.collectionView.frame.size.width - 16) / 3 + 25;
    self.itemSpace = 0;
    self.lineSpace = 0;
