...
@interface LSChatListViewController ()<LSPZPagingScrollViewDelegate,JDSegmentControlDelegate>
...
- (void)viewDidLoad {
    ...
    self.segment = [[JDSegmentControl alloc] initWithNumberOfTitles:@[@"All",@"Follow"] andFrame:CGRectMake(0, 0, SCREEN_WIDTH, 50) delegate:self isSymmetry:YES isShowbottomLine:YES];
    [self.topView addSubview:self.segment];
    
    LSMessageViewController * vc1 = [[LSMessageViewController alloc]initWithNibName:nil bundle:nil];
    [self addChildViewController:vc1];
    
    LSMessageViewController * vc2 = [[LSMessageViewController alloc]initWithNibName:nil bundle:nil];
