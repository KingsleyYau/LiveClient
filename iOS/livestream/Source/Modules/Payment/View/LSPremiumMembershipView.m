...
@interface LSPremiumMembershipView ()
...
@implementation LSPremiumMembershipView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.button setTitleColor:Color(0, 102, 255, 1) forState:UIControlStateNormal];
...
- (void)showMembershipView:(NSString *)message
{
    ...
    [richText addAttribute:NSForegroundColorAttributeName value:Color(121, 121, 121, 1) range:NSMakeRange(title.length, message.length - title.length)];
