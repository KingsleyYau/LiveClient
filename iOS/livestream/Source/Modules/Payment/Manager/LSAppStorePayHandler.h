...
@protocol LSAppStorePayHandlerDeleagte;

@interface LSAppStorePayHandler : NSObject
#pragma mark - 初始化
/**
 *  初始化
 *
 ...
 *  @return self
 */
- (id _Nonnull)initWithProductId:(NSString* _Nonnull)productId orderNo:(NSString* _Nonnull)orderNo manId:(NSString* _Nonnull)manId delegate:(id<LSAppStorePayHandlerDeleagte> _Nonnull)delegate;
...
@protocol LSAppStorePayHandlerDeleagte <NSObject>
@required
/**
 *  支付完成回调
 *
