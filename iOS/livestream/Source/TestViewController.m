...
- (IBAction)beauty:(id)sender {
    ...
    self.request = [self.requestManager login:@"userName" password:@"123456" checkcode:@"1234" finishHandler:^(BOOL success, NSString * _Nonnull errnum, NSString * _Nonnull errmsg) {
