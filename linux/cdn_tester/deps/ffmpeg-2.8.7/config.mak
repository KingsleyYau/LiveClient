...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build/ --disable-shared --enable-static --enable-gpl --enable-libx264 --enable-nonfree --enable-libfdk-aac --disable-doc --enable-version3 --enable-small --disable-vda --disable-iconv --disable-outdevs --disable-ffprobe --disable-ffplay --disable-ffserver --disable-asm --disable-encoders --enable-encoder=libx264 --enable-encoder=aac --disable-decoders --enable-decoder=h264 --enable-decoder=libfdk_aac --disable-demuxers --enable-demuxer=h264 --disable-parsers --enable-parser=h264
prefix=/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build/
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -I/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build/include -I/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build//include -I/opt/local/include/SDL -D_GNU_SOURCE=1 -D_THREAD_SAFE -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework QuartzCore -framework CoreServices -Wl,-framework,CoreFoundation -Wl,-framework,Security -L/opt/local/lib -lSDLmain -Wl,-framework,AppKit -lSDL -Wl,-framework,Cocoa -L/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build//lib -lx264 -lpthread -lm -ldl -L/Users/max/Documents/Svn/LiveStream/client/linux/cdn_tester/deps/build/lib -lfdk-aac -framework CoreGraphics -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
avdevice_FFLIBS=avfilter swscale postproc swresample avformat avcodec avutil
avfilter_FFLIBS=swscale postproc swresample avformat avcodec avutil
...
LIBS-ffplay=-L/opt/local/lib -lSDLmain -Wl,-framework,AppKit -lSDL -Wl,-framework,Cocoa
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
