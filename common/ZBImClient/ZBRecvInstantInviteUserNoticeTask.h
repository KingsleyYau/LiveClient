 ...
 * author: Alex
 *   date: 2018-03-08
 *   file: ZBRecvInstantInviteUserNoticeTask.h
 *   desc: 9.3.接收立即私密邀请通知 Task实现类
 */
...
class ZBRecvInstantInviteUserNoticeTask : public IZBTask
{
public:
	ZBRecvInstantInviteUserNoticeTask(void);
	virtual ~ZBRecvInstantInviteUserNoticeTask(void);
