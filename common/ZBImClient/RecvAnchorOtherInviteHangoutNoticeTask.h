 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorOtherInviteHangoutNoticeTask.h
 *   desc: 10.6.接收观众邀请其它主播加入多人互动通知Task实现类
 */
...
class RecvAnchorOtherInviteHangoutNoticeTask : public IZBTask
{
public:
	RecvAnchorOtherInviteHangoutNoticeTask(void);
	virtual ~RecvAnchorOtherInviteHangoutNoticeTask(void);
