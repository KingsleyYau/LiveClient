 ...
 * author: Alex
 *   date: 2018-04-09
 *   file: RecvAnchorInvitationHangoutNoticeTask.h
...
class RecvAnchorInvitationHangoutNoticeTask : public IZBTask
{
public:
	RecvAnchorInvitationHangoutNoticeTask(void);
	virtual ~RecvAnchorInvitationHangoutNoticeTask(void);
