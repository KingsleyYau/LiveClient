 ...
 * author: Alex
 *   date: 2018-03-05
 *   file: ZBRecvSendSystemNoticeTask.h
...
class ZBRecvSendSystemNoticeTask : public IZBTask
{
public:
	ZBRecvSendSystemNoticeTask(void);
	virtual ~ZBRecvSendSystemNoticeTask(void);
...
private:
    ...
    ZBIMSystemType    m_type;        // 公告类型（0:普通 1:警告）
