 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorDealKnockRequestNoticeTask.h
...
class RecvAnchorDealKnockRequestNoticeTask : public IZBTask
{
public:
	RecvAnchorDealKnockRequestNoticeTask(void);
	virtual ~RecvAnchorDealKnockRequestNoticeTask(void);
