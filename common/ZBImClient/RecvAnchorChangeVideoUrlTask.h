 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorChangeVideoUrlTask.h
...
class RecvAnchorChangeVideoUrlTask : public IZBTask
{
public:
	RecvAnchorChangeVideoUrlTask(void);
	virtual ~RecvAnchorChangeVideoUrlTask(void);
