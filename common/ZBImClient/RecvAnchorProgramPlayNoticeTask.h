 ...
 * author: Alex
 *   date: 2018-04-24
 *   file: RecvAnchorProgramPlayNoticeTask.h
...
class RecvAnchorProgramPlayNoticeTask : public IZBTask
{
public:
	RecvAnchorProgramPlayNoticeTask(void);
	virtual ~RecvAnchorProgramPlayNoticeTask(void);
