 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorLeaveHangoutRoomNoticeTask.h
...
class RecvAnchorLeaveHangoutRoomNoticeTask : public IZBTask
{
public:
	RecvAnchorLeaveHangoutRoomNoticeTask(void);
	virtual ~RecvAnchorLeaveHangoutRoomNoticeTask(void);
