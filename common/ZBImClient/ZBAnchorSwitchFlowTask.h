...
class ZBAnchorSwitchFlowTask : public IZBTask
{
public:
	ZBAnchorSwitchFlowTask(void);
	virtual ~ZBAnchorSwitchFlowTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& roomId, IMDeviceType deviceType);
...
private:
    ...
    IMDeviceType    m_deviceType;   // 终端类型
