 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorDealInviteHangoutNoticeTask.h
...
class RecvAnchorDealInviteHangoutNoticeTask : public IZBTask
{
public:
	RecvAnchorDealInviteHangoutNoticeTask(void);
	virtual ~RecvAnchorDealInviteHangoutNoticeTask(void);
