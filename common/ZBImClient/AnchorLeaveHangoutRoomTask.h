 ...
 * author: Alex
 *   date: 2018-04-9
 *   file: AnchorLeaveHangoutRoomTask.h
...
class AnchorLeaveHangoutRoomTask : public IZBTask
{
public:
    AnchorLeaveHangoutRoomTask(void);
    virtual ~AnchorLeaveHangoutRoomTask(void);
