 ...
 * author: Alex
 *   date: 2018-05-19
 *   file: RecvZBAnchorCountDownEnterRoomNoticeTask.h
...
class RecvZBAnchorCountDownEnterRoomNoticeTask : public IZBTask
{
public:
	RecvZBAnchorCountDownEnterRoomNoticeTask(void);
	virtual ~RecvZBAnchorCountDownEnterRoomNoticeTask(void);
