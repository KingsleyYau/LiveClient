 ...
 * author: Alex
 *   date: 2018-05-10
 *   file: RecvAnchorControlManPushHangoutNoticeTask.h
...
class RecvAnchorControlManPushHangoutNoticeTask : public IZBTask
{
public:
	RecvAnchorControlManPushHangoutNoticeTask(void);
	virtual ~RecvAnchorControlManPushHangoutNoticeTask(void);
