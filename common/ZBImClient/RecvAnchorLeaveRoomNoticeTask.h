 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorLeaveRoomNoticeTask.h
...
class RecvAnchorLeaveRoomNoticeTask : public IZBTask
{
public:
	RecvAnchorLeaveRoomNoticeTask(void);
	virtual ~RecvAnchorLeaveRoomNoticeTask(void);
