 ...
 * author: Alex
 *   date: 2018-03-07
 *   file: ZBRecvLeavingPublicRoomNoticeTask.h
...
class ZBRecvLeavingPublicRoomNoticeTask : public IZBTask
{
public:
	ZBRecvLeavingPublicRoomNoticeTask(void);
	virtual ~ZBRecvLeavingPublicRoomNoticeTask(void);
