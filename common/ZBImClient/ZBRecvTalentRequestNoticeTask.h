 ...
 * author: Alex
 *   date: 2018-03-07
 *   file: ZBRecvTalentRequestNoticeTask.h
 *   desc: 7.1.接收直播间才艺点播邀请通知 Task实现类
 */
...
class ZBRecvTalentRequestNoticeTask : public IZBTask
{
public:
	ZBRecvTalentRequestNoticeTask(void);
	virtual ~ZBRecvTalentRequestNoticeTask(void);
