 ...
 * author: Alex
 *   date: 2018-03-07
 *   file: ZBRecvRoomKickoffNoticeTask.h
...
class ZBRecvRoomKickoffNoticeTask : public IZBTask
{
public:
	ZBRecvRoomKickoffNoticeTask(void);
	virtual ~ZBRecvRoomKickoffNoticeTask(void);
