 ...
 * author: Alex
 *   date: 2018-03-05
 *   file: ZBRecvSendToastNoticeTask.h
 *   desc: 6.1.接收直播间弹幕通知（观众端／主播端接收直播间弹幕消息）Task实现类
 */
...
class ZBRecvSendToastNoticeTask : public IZBTask
{
public:
	ZBRecvSendToastNoticeTask(void);
	virtual ~ZBRecvSendToastNoticeTask(void);
