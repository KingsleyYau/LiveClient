 ...
 * author: Alex
 *   date: 2018-04-10
 *   file: RecvAnchorRecommendHangoutNoticeTask.h
...
class RecvAnchorRecommendHangoutNoticeTask : public IZBTask
{
public:
	RecvAnchorRecommendHangoutNoticeTask(void);
	virtual ~RecvAnchorRecommendHangoutNoticeTask(void);
