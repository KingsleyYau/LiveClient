 ...
 * author: Alex
 *   date: 2018-04-24
 *   file: RecvAnchorChangeStatusNoticeTask.h
 *   desc: 11.2.接收节目状态改变通知Task实现类
 */
...
class RecvAnchorChangeStatusNoticeTask : public IZBTask
{
public:
	RecvAnchorChangeStatusNoticeTask(void);
	virtual ~RecvAnchorChangeStatusNoticeTask(void);
