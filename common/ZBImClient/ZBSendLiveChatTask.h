...
class ZBSendLiveChatTask : public IZBTask
{
public:
	ZBSendLiveChatTask(void);
	virtual ~ZBSendLiveChatTask(void);
...
private:
    ...
    string          m_Msg;         // 文本消息内容
    list<string>    m_at;          // 用户ID，用于指定接收者（可无， 无则表示发送给直播间所有人）
