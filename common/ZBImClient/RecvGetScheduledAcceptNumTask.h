 ...
 * author: Alex
 *   date: 2019-11-08
 *   file: RecvGetScheduledAcceptNumTask.h
...
class RecvGetScheduledAcceptNumTask : public IZBTask
{
public:
	RecvGetScheduledAcceptNumTask(void);
	virtual ~RecvGetScheduledAcceptNumTask(void);
