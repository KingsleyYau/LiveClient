 ...
 * author: Alex
 *   date: 2018-05-12
 *   file: RecvAnchorHangoutChatNoticeTask.h
...
class RecvAnchorHangoutChatNoticeTask : public IZBTask
{
public:
	RecvAnchorHangoutChatNoticeTask(void);
	virtual ~RecvAnchorHangoutChatNoticeTask(void);
