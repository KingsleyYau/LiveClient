 ...
 * author: Alex
 *   date: 2018-04-11
 *   file: RecvAnchorEnterHangoutRoomNoticeTask.h
...
class RecvAnchorEnterHangoutRoomNoticeTask : public IZBTask
{
public:
	RecvAnchorEnterHangoutRoomNoticeTask(void);
	virtual ~RecvAnchorEnterHangoutRoomNoticeTask(void);
