 ...
 * author: Alex
 *   date: 2018-03-09
 *   file: ZBRecvInvitationAcceptNoticeTask.h
...
class ZBRecvInvitationAcceptNoticeTask : public IZBTask
{
public:
	ZBRecvInvitationAcceptNoticeTask(void);
	virtual ~ZBRecvInvitationAcceptNoticeTask(void);
...
private:
    ...
    string          m_invitationId;     // 预约ID
    long            m_bookTime;         // 预约时间（1970年起的秒数）
