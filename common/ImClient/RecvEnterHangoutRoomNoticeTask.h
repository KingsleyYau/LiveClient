 ...
 * author: Alex
 *   date: 2018-04-13
 *   file: RecvEnterHangoutRoomNoticeTask.h
 *   desc: 10.5.观众端/主播端接收观众/主播进入多人互动直播间通知Task实现类
 */
...
class RecvEnterHangoutRoomNoticeTask : public ITask
{
public:
	RecvEnterHangoutRoomNoticeTask(void);
	virtual ~RecvEnterHangoutRoomNoticeTask(void);
