...
class RecvFansRoomInTask : public ITask
{
public:
	RecvFansRoomInTask(void);
	virtual ~RecvFansRoomInTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& roomId, const string& userId, const string& nickName, const string& photoUrl);
