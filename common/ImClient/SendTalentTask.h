...
class SendTalentTask : public ITask
{
public:
	SendTalentTask(void);
	virtual ~SendTalentTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& roomId, const string& talentId);
