 ...
 * author: Alex
 *   date: 2018-04-14
 *   file: RecvLackCreditangoutNoticeTask.h
...
class RecvLackCreditangoutNoticeTask : public ITask
{
public:
	RecvLackCreditangoutNoticeTask(void);
	virtual ~RecvLackCreditangoutNoticeTask(void);
