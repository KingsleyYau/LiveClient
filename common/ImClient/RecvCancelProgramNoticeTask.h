 ...
 * author: Alex
 *   date: 2018-04-18
 *   file: RecvCancelProgramNoticeTask.h
...
class RecvCancelProgramNoticeTask : public ITask
{
public:
	RecvCancelProgramNoticeTask(void);
	virtual ~RecvCancelProgramNoticeTask(void);
