 ...
 * author: Alex
 *   date: 2018-06-14
 *   file:RecvPrivateMessageNoticeTask.h
...
class RecvPrivateMessageNoticeTask : public ITask
{
public:
	RecvPrivateMessageNoticeTask(void);
	virtual ~RecvPrivateMessageNoticeTask(void);
