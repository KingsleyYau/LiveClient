 ...
 * author: Alex
 *   date: 2019-03-06
 *   file: RecvHangoutCreditRunningOutNoticeTask.h
...
class RecvHangoutCreditRunningOutNoticeTask : public ITask
{
public:
	RecvHangoutCreditRunningOutNoticeTask(void);
	virtual ~RecvHangoutCreditRunningOutNoticeTask(void);
