 ...
 * author: Alex
 *   date: 2018-04-13
 *   file: RecvDealInviteHangoutNoticeTask.h
...
class RecvDealInviteHangoutNoticeTask : public ITask
{
public:
	RecvDealInviteHangoutNoticeTask(void);
	virtual ~RecvDealInviteHangoutNoticeTask(void);
