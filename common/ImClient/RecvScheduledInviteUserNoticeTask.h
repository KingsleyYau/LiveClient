 ...
 * author: Alex
 *   date: 2017-08-28
 *   file: RecvScheduledInviteUserNoticeTask.h
...
class RecvScheduledInviteUserNoticeTask : public ITask
{
public:
	RecvScheduledInviteUserNoticeTask(void);
	virtual ~RecvScheduledInviteUserNoticeTask(void);
