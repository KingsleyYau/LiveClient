 ...
 * author: Alex
 *   date: 2017-08-15
 *   file: RecvLeavingPublicRoomNoticeTask.h
...
class RecvLeavingPublicRoomNoticeTask : public ITask
{
public:
	RecvLeavingPublicRoomNoticeTask(void);
	virtual ~RecvLeavingPublicRoomNoticeTask(void);
