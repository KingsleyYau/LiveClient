 ...
 * author: Alex
 *   date: 2017-06-12
 *   file: RecvRoomToastNoticeTask.h
 *   desc: 7.2.接收直播间弹幕通知（观众端／主播端接收直播间弹幕消息）Task实现类
 */
...
class RecvRoomToastNoticeTask : public ITask
{
public:
	RecvRoomToastNoticeTask(void);
	virtual ~RecvRoomToastNoticeTask(void);
