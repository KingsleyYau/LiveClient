 ...
 * author: Alex
 *   date: 2018-04-13
 *   file: RecvRecommendHangoutNoticeTask.h
...
class RecvRecommendHangoutNoticeTask : public ITask
{
public:
	RecvRecommendHangoutNoticeTask(void);
	virtual ~RecvRecommendHangoutNoticeTask(void);
