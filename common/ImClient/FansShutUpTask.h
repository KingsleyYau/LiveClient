 ...
 * author: Alex
 *   date: 2017-06-12
 *   file: FansShutUpTask.h
 *   desc: 3.7.主播禁言观众（直播端把制定观众禁言）Task实现类
 */
...
class FansShutUpTask : public ITask
{
public:
	FansShutUpTask(void);
	virtual ~FansShutUpTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& roomId, const string userId, int timeOut);
