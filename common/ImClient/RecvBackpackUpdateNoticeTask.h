 ...
 * author: Alex
 *   date: 2017-08-29
 *   file: RecvBackpackUpdateNoticeTask.h
...
class RecvBackpackUpdateNoticeTask : public ITask
{
public:
	RecvBackpackUpdateNoticeTask(void);
	virtual ~RecvBackpackUpdateNoticeTask(void);
