 ...
 * author: Alex
 *   date: 2018-04-13
 *   file: RecvLeaveHangoutRoomNoticeTask.h
...
class RecvLeaveHangoutRoomNoticeTask : public ITask
{
public:
	RecvLeaveHangoutRoomNoticeTask(void);
	virtual ~RecvLeaveHangoutRoomNoticeTask(void);
