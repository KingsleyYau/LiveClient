 ...
 * author: Alex
 *   date: 2017-08-28
 *   file: RecvInstantInviteUserNoticeTask.h
...
class RecvInstantInviteUserNoticeTask : public ITask
{
public:
	RecvInstantInviteUserNoticeTask(void);
	virtual ~RecvInstantInviteUserNoticeTask(void);
