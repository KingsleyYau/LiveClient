 ...
 * author: Alex
 *   date: 2017-08-18
 *   file: RecvWaitStartOverNoticeTask.h
...
class RecvWaitStartOverNoticeTask : public ITask
{
public:
	RecvWaitStartOverNoticeTask(void);
	virtual ~RecvWaitStartOverNoticeTask(void);
