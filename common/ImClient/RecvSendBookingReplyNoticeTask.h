 ...
 * author: Alex
 *   date: 2017-08-29
 *   file: RecvSendBookingReplyNoticeTask.h
...
class RecvSendBookingReplyNoticeTask : public ITask
{
public:
	RecvSendBookingReplyNoticeTask(void);
	virtual ~RecvSendBookingReplyNoticeTask(void);
