...
static const string CMD_RECVLEAVINGPUBLICROOMNOTICE = "imShare/leavingPublicRoomNotice";    // 3.7.接收关闭直播间倒数通知
...
static const string CMD_RECVSENDBOOKINGREPLYNOTICE =   "imMan/sendBookingReplyNotice"; // 7.6.接收预约私密邀请回复通知
