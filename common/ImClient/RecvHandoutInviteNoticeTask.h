 ...
 * author: Alex
 *   date: 2019-01-21
 *   file: RecvHandoutInviteNoticeTask.h
...
class RecvHandoutInviteNoticeTask : public ITask
{
public:
	RecvHandoutInviteNoticeTask(void);
	virtual ~RecvHandoutInviteNoticeTask(void);
