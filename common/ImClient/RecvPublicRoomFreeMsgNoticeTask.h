 ...
 * author: Alex
 *   date: 2019-09-11
 *   file: RecvPublicRoomFreeMsgNoticeTask.h
...
class RecvPublicRoomFreeMsgNoticeTask : public ITask
{
public:
	RecvPublicRoomFreeMsgNoticeTask(void);
	virtual ~RecvPublicRoomFreeMsgNoticeTask(void);
