 ...
 * author: Alex
 *   date: 2017-08-18
 *   file: SendCancelPrivateLiveInviteTask.h
...
class SendCancelPrivateLiveInviteTask : public ITask
{
public:
	SendCancelPrivateLiveInviteTask(void);
	virtual ~SendCancelPrivateLiveInviteTask(void);
