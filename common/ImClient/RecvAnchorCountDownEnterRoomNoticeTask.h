 ...
 * author: Alex
 *   date: 2018-05-19
 *   file: RecvAnchorCountDownEnterRoomNoticeTask.h
...
class RecvAnchorCountDownEnterRoomNoticeTask : public ITask
{
public:
	RecvAnchorCountDownEnterRoomNoticeTask(void);
	virtual ~RecvAnchorCountDownEnterRoomNoticeTask(void);
