 ...
 * author: Alex
 *   date: 2018-05-25
 *   file:RecvTalentListNoticeTask.h
 *   desc: 8.3.接收直播间才艺点播提示公告通知 Task实现类
 */
...
class RecvTalentListNoticeTask : public ITask
{
public:
	RecvTalentListNoticeTask(void);
	virtual ~RecvTalentListNoticeTask(void);
