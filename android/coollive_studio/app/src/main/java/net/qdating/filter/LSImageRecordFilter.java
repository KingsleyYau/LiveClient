 ...
 *
 */
public class LSImageRecordFilter extends LSImageBufferFilter {
	...
	public LSImageRecordFilter(LSImageRecordFilterCallback callback) {
		super(vertexShaderString, fragmentShaderString, LSImageVertex.filterVertex_180);
	...
	private void createGLPBO() {
        ...
        Log.d(LSConfig.TAG, String.format("LSImageRecordFilter::createGLPBO( glPBOCount : %d ) ", glPBOCount));
	}
