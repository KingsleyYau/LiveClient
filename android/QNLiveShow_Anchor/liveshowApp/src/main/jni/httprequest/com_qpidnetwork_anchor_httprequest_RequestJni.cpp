/*
 * com_qpidnetwork_anchor_httprequest_RequestJni.cpp
 *
 *  Created on: 2017-5-17
 *      Author: Hunter Mun
 */
#include "GlobalFunc.h"
#include "com_qpidnetwork_anchor_httprequest_RequestJni.h"
...
/*
 * Class:     com_qpidnetwork_anchor_httprequest_RequestJni
 * Method:    SetLogDirectory
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetLogDirectory
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetVersionCode
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetCookiesDirectory
  (JNIEnv *env, jclass cls, jstring directory){
	const char *cpDirectory = env->GetStringUTFChars(directory, 0);
 ...
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetWebSite
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetPhotoUploadSite
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetConfigSite
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_StopRequest
 ...
 */
JNIEXPORT jstring JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_GetLocalMacMD5
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetDeviceId
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_CleanCookies
  (JNIEnv *, jclass) {
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_GetCookiesItem
  (JNIEnv *env, jclass cls)
{
	...
	jclass jItemCls = env->FindClass("com/qpidnetwork/anchor/httprequest/item/CookiesItem");
	if(!jItemCls)
	{
 ...
 */
JNIEXPORT void JNICALL Java_com_qpidnetwork_anchor_httprequest_RequestJni_SetProxy
