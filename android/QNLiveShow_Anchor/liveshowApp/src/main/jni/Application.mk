...
APP_CFLAGS += -O2 -D_ANDROID -DMG_ENABLE_SSL -D_HTTPS_SUPPORT -D_ANDROID_NDK_VERSION=16 -g -O0 -DPRINT_JNI_LOG -DFILE_JNI_LOG#-O2#-DHAVE_PTHREADS -DHAVE_ANDROID_OS=1 -g #-std=c++0x#-std=gnu++0x
