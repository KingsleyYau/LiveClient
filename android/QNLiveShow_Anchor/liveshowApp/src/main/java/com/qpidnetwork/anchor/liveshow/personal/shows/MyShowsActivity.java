...
public class MyShowsActivity extends BaseActionBarFragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    public static void launchMyShowsActivity(Context context, int defultSelectIndex) {
        Intent intent = new Intent(context, MyShowsActivity.class);
    ...
    protected void onCreate(Bundle arg0) {
        ...
        //设置头
        setTitle(getString(R.string.my_shows_title), Color.BLACK);
...
//        getPackageUnreadCount();
    ...
    public class MyTicketsAdapter extends FragmentPagerAdapter {
        ...
        public MyTicketsAdapter(FragmentActivity activity) {
            ...
            mTitles = activity.getResources().getStringArray(R.array.myShowsTags);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: {
                    fragment = ShowsFragment.newInstance(RequestJniProgram.ProgramSortType.VerifyPass );
                }
                break;

                case 1: {
                    fragment = ShowsFragment.newInstance(RequestJniProgram.ProgramSortType.History );
                }
                break;
