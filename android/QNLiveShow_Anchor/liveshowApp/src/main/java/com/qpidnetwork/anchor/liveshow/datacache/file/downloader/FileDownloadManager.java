package com.qpidnetwork.anchor.liveshow.datacache.file.downloader;
...
import com.qpidnetwork.anchor.framework.filedownloader.HttpsTrustManager;
import com.qpidnetwork.anchor.framework.filedownloader.SSLSupportsUrlConnection;
...
public class FileDownloadManager {
    ...
    public static void init(Context context, boolean debugLog){
        ...
        FileDownloader.setupOnApplicationOnCreate((Application) context).connectionCreator(new SSLSupportsUrlConnection.Creator()).commit();
    }
