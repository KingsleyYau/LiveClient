...
import com.qpidnetwork.anchor.httprequest.OnGetScheduleInviteListCallback;
import com.qpidnetwork.anchor.httprequest.RequstJniSchedule;
        ...
        mAdapter.setOnComfirmedInviteClickListener(new ComfirmedInviteAdapter.OnComfirmedInviteEventListener() {
            ...
            public void onStartEnterRoomClick(BookInviteItem item) {
                ...
                if(item != null && !TextUtils.isEmpty(item.roomId)){
                    ...
                    Intent intent = LiveRoomTransitionActivity.getEnterRoomIntent(getActivity(), anchorId, item.oppositeNickname, item.oppositePhotoUrl, item.roomId);
