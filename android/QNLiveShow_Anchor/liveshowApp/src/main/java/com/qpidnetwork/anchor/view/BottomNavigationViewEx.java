...
/**
 * Created by Jagger on 2018/2/26.
 * 来自: https://github.com/ittianyu/BottomNavigationViewEx
 * 改造过程: http://blog.csdn.net/qq_35064774/article/details/54177702
 */
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    public void setItemPadding(int position, int left, int top, int right, int bottom) {
        getBottomNavigationItemView(position).setPadding(left , top , right , bottom);
    }

    public void setItemEnabled(int position, boolean enabled) {
        getBottomNavigationItemView(position).setEnabled(enabled);
    }
    ...
    /**
     * set icon可使用selector, 在menu.xml中android:icon="@drawable/selector_xx"即可
     */
    public void setIconUseSelector(){
        /**
         * 不使用着色器
         */
