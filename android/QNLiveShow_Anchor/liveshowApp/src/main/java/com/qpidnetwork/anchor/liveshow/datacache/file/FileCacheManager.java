package com.qpidnetwork.anchor.liveshow.datacache.file;
...
public class FileCacheManager {
    private final String LOCAL_CACHE_ROOT_DIR = "LiveShow";
    ...
    private final String PLAYER_PUBLISH_LOG_DIR = "coollive";   //
...
//        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + context.getResources().getString(R.string.app_name);
    ...
    /**
     * 获取推流器/播放器本地缓存目录（库内部获取sd卡目录拼接）
     * @return
     */
    public String GetPublisherPlayerLogLocalPath(){
        String path = LOCAL_CACHE_ROOT_DIR + "/" + PLAYER_PUBLISH_LOG_DIR;
        return path;
    }
