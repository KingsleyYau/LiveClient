...
public class DialogAssigner implements Assignable {
    ...
    @Override
    public BuildBean assignJDatePick(Context context, int gravity, String dateTitle, long selectDate, int maxYear, int minYear, int dateType, int tag, DialogUIDateTimeSaveListener listener) {
        ...
        bean.type = DialogConfig.TYPE_JDATEPICK;
        bean.dateTimeListener = listener;
        bean.dateType = dateType;
        bean.date = selectDate;
        bean.maxYear = maxYear;
        bean.minYear = minYear;
        bean.tag = tag;
        return bean;
    }
    ...
    public BuildBean assignAlert(Context activity, CharSequence title, CharSequence msg,
                                 ...
                                 boolean isVertical, boolean cancelable, boolean outsideTouchable, DialogUIListener listener) {
        BuildBean bean = new BuildBean();
        bean.mContext = activity;
        bean.msg = msg;
        bean.title = title;
        ...
        bean.text1 = firstTxt;
        bean.text2 = secondTxt;
        bean.btn1Color = firstTxtColor;
        bean.btn2Color = secondTxtColor;
        bean.isVertical = isVertical;
        bean.gravity = Gravity.CENTER;
