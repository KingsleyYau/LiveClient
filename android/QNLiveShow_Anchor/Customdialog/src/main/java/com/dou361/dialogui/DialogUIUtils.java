...
public class DialogUIUtils {
     ...
     * @return
     */
    public static BuildBean showSheet(Context context, CharSequence titleTxt, List<TieBean> datas, CharSequence bottomTxt, int gravity, boolean cancleable, boolean outsideTouchable, DialogUIItemListener listener) {
        return DialogAssigner.getInstance().assignSheet(context, titleTxt, datas, bottomTxt, gravity, cancleable, outsideTouchable, listener);
    }
     ...
     * @return
     */
    public static BuildBean showCustomAlert(Context context, View contentView ,CharSequence firstTxt, CharSequence secondTxt) {
        return showCustomAlert(context, contentView, firstTxt , secondTxt , Gravity.CENTER, true, true , null);
    }
    ...
    public static BuildBean showCustomAlert(Context context, View contentView, int gravity) {
        return showCustomAlert(context, contentView, null , null , gravity, true, true , null);
    }
