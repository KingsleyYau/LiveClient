...
public abstract class IMClientListener {
	 ...
	 * @param status
	 */
	public abstract void OnRecvSendTalentNotice(String roomId, String talentInviteId, String talentId, String name, double credit, TalentInviteStatus status, double rebateCredit);
	public void OnRecvSendTalentNotice(String roomId, String talentInviteId, String talentId, String name, double credit, int status, double rebateCredit){
		OnRecvSendTalentNotice(roomId, talentInviteId, talentId, name, credit, intToTalentInviteStatus(status), rebateCredit);
	}
