package com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.adapter;
...
public class LoopViewPagerAdapter extends BaseLoopPagerAdapter {
    ...
    private final List<com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.model.Character> mHeroes;
    ...
    public void setList(List<com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.model.Character> heroes) {
        mHeroes.clear();
    ...
    private void initIndicators() {
        if (mIndicators.getChildCount() != mHeroes.size() && mHeroes.size() > 1) {
            ...
            for (int i = 0; i < getPagerCount(); i++) {
                ...
                Drawable drawable = res.getDrawable(R.drawable.swipetoloadlayout_selector_indicator);
    ...
    @Override
    public com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.model.Character getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.swipetoloadlayout_item_viewpager, parent, false);
        ...
        com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.model.Character character = mHeroes.get(position);
