...
public class MaterialDialogAlert extends BaseDialog {
    ...
    protected void createView() {
        ...
        LinearLayout customView = new LinearLayout(this.getContext());
        customView.setLayoutParams(customParams);
        customView.setId(R.id.live_dialog_custom_view);
        ...
        messageView.addView(customView);
    ...
    public void setCustomView(View view){
        getCustomView().addView(view);
        getCustomView().setVisibility(View.VISIBLE);
    }

    public LinearLayout getCustomView(){
        return (LinearLayout)contentView.findViewById(R.id.live_dialog_custom_view);
    }
