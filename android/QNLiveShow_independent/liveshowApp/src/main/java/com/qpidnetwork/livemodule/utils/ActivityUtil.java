...
//        }
     ...
     * @param shareContent
     */
    public static void getShareIntent(Context context, Uri imageUri, String shareTitle, String shareContent) {
        android.util.Log.d(TAG, "getShareIntent-imageUri:" + imageUri
...
//        shareIntent.setType("text/plain");
     ...
     * @param shareContent
     */
    public static void getShareIntent(Context context, String shareContent) {
        Intent shareIntent = new Intent();
        shareIntent.setAction(Intent.ACTION_SEND);
        shareIntent.putExtra(Intent.EXTRA_TEXT, shareContent);
        shareIntent.setType("text/plain");
