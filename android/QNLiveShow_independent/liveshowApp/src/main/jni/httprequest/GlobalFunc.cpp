...
string gToken;
 ...
 jint JNI_OnLoad(JavaVM* vm, void* reserved) {
	 ...
	 jobject jManBaseInfoItem;
	 InitClassHelper(env, OTHER_MANBASEINFO_ITEM_CLASS, &jManBaseInfoItem);
	 gJavaItemMap.insert(JavaItemMap::value_type(OTHER_MANBASEINFO_ITEM_CLASS, jManBaseInfoItem));
