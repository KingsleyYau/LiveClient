...
public class PowerfulStickyDecoration extends BaseDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (curGroupName == null || TextUtils.equals(curGroupName, preGroupName)) {
                ...
                int bottom = 0;
                if(isGroupHolding){
                    bottom = Math.max(mGroupHeight, childView.getTop() + parent.getPaddingTop());
                }else {
                    bottom = childView.getTop() + parent.getPaddingTop();
                }
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder isGroupHolding(boolean b) {
            mDecoration.isGroupHolding = b;
            return this;
        }
