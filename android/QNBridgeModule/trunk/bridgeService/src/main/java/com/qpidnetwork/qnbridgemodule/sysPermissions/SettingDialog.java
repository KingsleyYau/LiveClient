...
//                .setNegativeButton(R.string.permission_cancel, mClickListener);
    ...
    public SettingDialog setNegativeButton(@NonNull String text, @Nullable DialogInterface.OnClickListener
            negativeListener) {
        mNegativeButtonOnClickListener = negativeListener;
        mBuilder.setNegativeButton(text, mClickListener);
        return this;
    }
    ...
    @NonNull
    public SettingDialog setPositiveButton(@NonNull String text, DialogInterface.OnClickListener
            negativeListener) {
            ...
            switch (which) {
                case DialogInterface.BUTTON_NEGATIVE:
                    ...
                    if(mNegativeButtonOnClickListener != null){
                        mNegativeButtonOnClickListener.onClick(dialog,which);
                    }
                    break;
