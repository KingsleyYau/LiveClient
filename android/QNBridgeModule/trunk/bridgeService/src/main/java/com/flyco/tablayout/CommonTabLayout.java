...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    // 2019/9/5 Hardy
    private int mTabBgSelectColor;
    private int mTabBgUnselectColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        // 2019/9/5 Hardy
        mTabBgSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_tab_background_select_color, Color.TRANSPARENT);
        mTabBgUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_tab_background_un_select_color, Color.TRANSPARENT);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            // 2019/9/5 Hardy 设置背景选中与否
            tabView.setBackgroundColor(i == mCurrentTab ? mTabBgSelectColor : mTabBgUnselectColor);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            // 2019/9/5 Hardy 设置背景选中与否
            tabView.setBackgroundColor(isSelect ? mTabBgSelectColor : mTabBgUnselectColor);
        }
    }
