...
public:
	LSPublisherImp(jobject jniCallback, jboolean useHardEncoder, jobject jniVideoEncoder, int width, int height, int fps, int keyFrameInterval, int bitrate);
	...
	bool UpdateVideoParam(int width, int height, int fps, int keyFrameInterval, int bitrate);
