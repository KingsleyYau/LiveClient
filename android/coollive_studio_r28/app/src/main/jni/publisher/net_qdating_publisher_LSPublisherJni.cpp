...
JNIEXPORT jlong JNICALL Java_net_qdating_publisher_LSPublisherJni_Create
  (JNIEnv *env, jobject thiz, jobject callback, jboolean useHardEncoder, jobject videoEncoder, jint width, jint height, jint bitrate, jint keyFrameInterval, jint fps) {
	// RTMP推送器
	LSPublisherImp* publisher = new LSPublisherImp(callback, useHardEncoder, videoEncoder, width, height, fps, keyFrameInterval, bitrate);
...
JNIEXPORT jboolean JNICALL Java_net_qdating_publisher_LSPublisherJni_UpdateVideoParam
  (JNIEnv *env, jobject thiz, jlong jpublisher, jint width, jint height, jint fps, jint keyFrameInterval, jint bitrate) {
    bool bFlag = true;

    LSPublisherImp* publisher = (LSPublisherImp *)jpublisher;
	bFlag = publisher->UpdateVideoParam(width, height, fps, keyFrameInterval, bitrate);
