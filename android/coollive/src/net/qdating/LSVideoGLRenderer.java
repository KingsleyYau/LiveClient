...
public class LSVideoGLRenderer implements Renderer {
	private final static String TAG = "livestream";
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		// TODO Auto-generated method stub
        Log.i(TAG, String.format("LSAudioRenderer::onSurfaceChanged( width : %d, height : %d ) ", width, height));
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		// TODO Auto-generated method stub
        Log.i(TAG, String.format("LSAudioRenderer::onSurfaceCreated() "));
