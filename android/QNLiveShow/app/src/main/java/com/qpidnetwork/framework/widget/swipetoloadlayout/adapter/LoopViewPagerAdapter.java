package com.qpidnetwork.framework.widget.swipetoloadlayout.adapter;
...
public class LoopViewPagerAdapter extends BaseLoopPagerAdapter {
    ...
    private final List<com.qpidnetwork.framework.widget.swipetoloadlayout.model.Character> mHeroes;
    ...
    public void setList(List<com.qpidnetwork.framework.widget.swipetoloadlayout.model.Character> heroes) {
        mHeroes.clear();
    ...
    @Override
    public com.qpidnetwork.framework.widget.swipetoloadlayout.model.Character getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        com.qpidnetwork.framework.widget.swipetoloadlayout.model.Character character = mHeroes.get(position);
