...
public class CarManager {
    ...
    public static final long normalAnimStartPlayTime = 2000l;
    public static final long normalAnimPlayingTime = 1000l;
    public static final long normalAnimEndPlayTime = 300l;
    public static final long quequeAnimPlayTime = 500l;
    ...
    private void playCarInAnim(final CarView carView){
        ...
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(carView, "translationX",
                translationX+carViewMeasureWidth+rightMargin, translationX);
