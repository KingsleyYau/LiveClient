...
//        view.startAnimation(animationSet);
        ...
        animator1.setDuration(980l);
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(view, "scaleY", 2.0f,/*0.8f,*/0.6f, 1f, 1f, 1f, 1f, 1f);
        animator2.setDuration(980l);
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(view, "scaleX", 2.0f,/*0.8f,*/0.6f, 1f, 1f, 1f, 1f, 1f);
        animator3.setDuration(980l);
