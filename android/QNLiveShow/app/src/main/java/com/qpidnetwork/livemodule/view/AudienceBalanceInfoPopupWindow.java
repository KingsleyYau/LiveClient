...
//        this.setBackgroundDrawable(dw);
    ...
    private void updateViewData() {
        ...
        switch (manLevel){
            case 1:
                levelResId = R.drawable.ic_balance_userlevel_1;
                break;
            default:
                levelResId = R.drawable.ic_balance_userlevel_1;
                break;
        }
        iv_userLevel.setImageDrawable(context.getResources().getDrawable(levelResId));
        ...
        ForegroundColorSpan foregroundColorSpan1 = new ForegroundColorSpan(Color.parseColor("#383838"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_backBalanceDialog:
                dismiss();
                break;
            case R.id.btn_gotoRecharge:
