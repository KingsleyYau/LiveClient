...
public class GiftToast{
    ...
    public GiftToast(Activity context,long showTime){
        this.showTime = showTime;
        this.context = new WeakReference<Activity>(context);
        toast = new Toast(context);
        toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM,0, DisplayUtil.dip2px(context,64f));
        toast.setView(View.inflate(context,R.layout.view_gift_toast, null));
    }
