...
#include <jni.h>
/* Header for class com_qpidnetwork_httprequest_RequestJni */

#ifndef _Included_com_qpidnetwork_httprequest_RequestJni
#define _Included_com_qpidnetwork_httprequest_RequestJni
#ifdef __cplusplus
extern "C" {
#endif
/*
