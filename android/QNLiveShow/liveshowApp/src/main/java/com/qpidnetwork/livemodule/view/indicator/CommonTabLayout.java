 ...
 * <p>
 * e.g
 * <com.qpidnetwork.livemodule.view.indicator.CommonTabLayout
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.layout_common_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.layout_common_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.layout_common_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.layout_common_tab_top, null);
            }
...
//                mIndicatorDrawable.setColor(mIndicatorColor);
                // 2019/3/13 hardy  设置了渐变条，该颜色就不设置
...
//                mIndicatorDrawable.setColor(mIndicatorColor);
    ...
    public void setIndicatorGradientColor(int[] colors) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, colors);
        }
