...
public class CreditsTipsPopupWindow extends PopupWindow implements View.OnClickListener {

    private final String TAG = CreditsTipsPopupWindow.class.getSimpleName();
    ...
    public CreditsTipsPopupWindow(Context context) {
        super();
        Log.d(TAG, "CreditsTipsPopupWindow");
