...
public class PayPublicLiveRoomActivity extends BaseCommonLiveRoomActivity {
    ...
    public void initData() {
        ...
        if(null != mIMRoomInItem && mIMRoomInItem.usedVoucher){
            ...
            showThreeSecondTips(getResources().getString(R.string.liveroom_paypublic_usedVoucher), Gravity.CENTER);
        }
    }
    ...
    protected void addRebateGrantedMsg(double rebateGranted) {
        ...
        IMMessageItem imMessageItem = new IMMessageItem(mIMRoomInItem.roomId,
                ...
                new IMSysNoticeMessageContent(getResources().getString(R.string.system_announcement_recv_rebate,String.valueOf(rebateGranted)),
