...
public class RoomThemeManager {
     ...
     * @return
     */
    public int getRoomMsgListRoomInMsgStrResId(IMRoomInItem.IMLiveRoomType liveRoomType){
        int strResId = 0;
        if(IMRoomInItem.IMLiveRoomType.FreePublicRoom == liveRoomType){
     ...
     * @return
     */
    public int getRoomMsgListTxtMsgStrResId(IMRoomInItem.IMLiveRoomType liveRoomType){
        int strResId = 0;
        if(IMRoomInItem.IMLiveRoomType.FreePublicRoom == liveRoomType){
     ...
     * @return
     */
    public int getRoomMsgListGiftMsgStrResId(IMRoomInItem.IMLiveRoomType liveRoomType){
        int strResId = 0;
        if(IMRoomInItem.IMLiveRoomType.FreePublicRoom == liveRoomType){
