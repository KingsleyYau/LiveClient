...
import com.qpidnetwork.livemodule.framework.widget.swipetoloadlayout.SwipeRefreshHeaderLayout;
...
public class TwitterRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    public TwitterRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rotateUp = AnimationUtils.loadAnimation(context, R.anim.swipetoloadlayout_rotate_up);
        rotateDown = AnimationUtils.loadAnimation(context, R.anim.swipetoloadlayout_rotate_down);
    }
