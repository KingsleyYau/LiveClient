...
public class VerifyMobileActivity extends BaseActionBarFragmentActivity {
    ...
    private final int MAX_RESEND_TIME = 5;
    ...
    private ButtonRaised mBtnResend , mBtnSummit , mBtnErrorBack;
    private MaterialTextField mEtVerifyCode;
    private ConstraintLayout mConstraintLayoutContent , mConstraintLayoutError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置头
        setTitle(getString(R.string.live_book_verify_num_title), Color.GRAY);
    ...
    private void onSummit(){
        RequestJniOther.SubmitPhoneVerifyCode(mCountry, mAreaCode, mPhone, mEtVerifyCode.getText().toString() , new OnRequestCallback() {
            @Override
            public void onRequest(boolean isSuccess, int errCode, String errMsg) {
                if(isSuccess){
