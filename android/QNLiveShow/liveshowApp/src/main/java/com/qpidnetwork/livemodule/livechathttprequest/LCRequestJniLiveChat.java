...
public class LCRequestJniLiveChat {
	 ...
	 * @return
	 */
	static public native long CheckPhoto(String targetId, String inviteId, String userId, String sid, String photoId, OnLCCheckPhotoCallback callback);
...
//
	 ...
	 * @return				请求唯一Id
	 */
	static public native long UploadManPhoto(
			String file,
			OnLCUploadManPhotoCallback callback);
